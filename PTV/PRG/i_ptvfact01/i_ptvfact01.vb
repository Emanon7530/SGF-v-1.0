...
Public Class i_ptvfact01
    ...
    Dim oSeguimiento As SeguimientoAsegurado
    Dim oSeguimientos As CollectionSeguimientoAsegurado
    ...
    Dim isDomiciMide As Boolean
    Dim isClienteAntes As Boolean
    Dim isVendm As Boolean
    Dim verEntrada As Boolean
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents xgcol_usocontinuo As LibX.XDataGridBoolColumn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.xgcol_usocontinuo = New LibX.XDataGridBoolColumn
        ...
        'DataColumn84
        '
        Me.DataColumn84.Caption = "entrada"
        Me.DataColumn84.ColumnName = "entrada"
        Me.DataColumn84.DataType = GetType(System.Int32)
        '
        'DataColumn90
        '
        Me.DataColumn90.ColumnName = "ind_continuo"
        Me.DataColumn90.DataType = GetType(System.Int32)
        '
        'ftsegrm
        '
        Me.ftsegrm.Columns.AddRange(New System.Data.DataColumn() {Me.DataColumn57, Me.DataColumn59, Me.DataColumn60, Me.DataColumn61, Me.DataColumn62, Me.DataColumn63, Me.DataColumn64, Me.DataColumn81, Me.DataColumn89, Me.DataColumn77, Me.DataColumn80, Me.DataColumn87})
        ...
        'DataColumn87
        '
        Me.DataColumn87.ColumnName = "ind_usocontinuo"
        ...
        Me.xdt_ftfactm.Source = New String() {"SELECT", "ftfactm.ftserial_no,", "ftfactm.whse_code,", "ftfactm.suc_code,", "ftfactm.dev_type,", "ftfactm.cotiz_serial,", "ftfactm.term_code,", "ftfactm.addr_code,", "ftfactm.vend_code,", "ftfactm.fact_number,", "ftfactm.fact_date,", "ftfactm.fact_create,", "ftfactm.fact_total,", "ftfactm.descto,", "ftfactm.itbis,", "ftfactm.userid,", "ftfactm.fact_status,", "ftfactm.date_created,", "ftfactm.type_code,", "ftfactm.cust_code,", "ftfactm.fact_cond,", "ftfactm.bus_name,", "ftfactm.address,", "ftfactm.fact_nota,", "ftfactm.ftserial_afect,", "ftfactm.pay_adelant,", "ftfactm.phone,", "ftfactm.pay_mora,", "ftfactm.porc_comision,", "ftfactm.caja_code,", "ftfactm.caje_code,", "ftfactm.fact_inddomicilio,", "ftfactm.fact_impresa,", "ftfactm.fact_ncf,", "cjtranrv.init_serial,", "cjtranrv.efectivo,", "cjtranrv.vuelto,", "cjtranrv.tarjeta,", "cjtranrv.credito,", "cjtranrv.notacredito,", "cjtranrv.cheque,", "cjtranrv.seguro,", "ftafectm.ftserial_no afect_serial,", "ftafectm.fact_number afect_number,", "ftsegrm.aseg_poliza,", "ftsegrm.cia_serial,", "ftfactm.seg_amount,", "ftfactm.prov_code,", "ftfactm.cust_serial,", "ftfactm.fact_time,", "ftfactm.ncf_type", "from ftfactm ", "WITH (HOLDLOCK, ROWLOCK) ", "left outer join cjtranrv  ", "on  ftfactm.ftserial_no = cjtranrv.ftserial_no ", "left outer join ftfactm ftafectm", "on ftfactm.ftserial_afect = ftafectm.ftserial_no", "left outer join ftsegrm", "on ftfactm.ftserial_no = ftsegrm.ftserial_no", "  where ftfactm.type_code in('FPV','FSG','FTS','DEV')", "  and (ftfactm.ftserial_no in(select ftserial_no from ftfactd)", "   or ftfactm.ftserial_no in(select ftserial_no from ftfactd1))"}
        ...
        Me.xdt_ftfactd.AutoIncrementSerial = True
        ...
        Me.xtxresponsable.Location = New System.Drawing.Point(96, 136)
        ...
        Me.xlk_type_code.DestParameters = New String() {"xtxt_type_code=type_code", "lbltype_name=type_name"}
        ...
        Me.xlk_type_code.SrcParameters = New String() {"xtxt_type_code=type_code"}
        ...
        Me.xlk_type_code.VisParameters = New String() {"Código=type_code", "Documento=type_name"}
        ...
        Me.xcbo_fact_status.Items.AddRange(New Object() {"0-Anulada", "1-Pendiente", "2-Cobrada", "3-en Espera", "4-Domicilio Pendiente", "5-Pendiente Preparar"})
        ...
        Me.xlk_item_code.SizesColumnsTab = New String() {"item_name=200", "prov_name=200"}
        Me.xlk_item_code.SqlString = New String() {"SELECT DISTINCT ivitemv1.item_code,item_name,ivitemv1.unit_code,", "                             ivunitd.factor,ivitemv1.price,existencia,", "                             isnull(vw_iventrdp.entrada,0) as entrada,ivitemv1.pr" & _
        "ov_code,", "                            purch_cost,ubicacion,cpprovm.prov_name,brand_name,", "                           aplica_dscnt,0 dscto,precioitbis,disc_pct,", "                           isnull(prd_controlado,0)prd_controlado,sustancias,", "                          ivitemv1.dia", "FROM ivitemv1 ", "INNER JOIN cpprovm ON cpprovm.prov_code = ivitemv1.prov_code", "LEFT OUTER JOIN ivcbarram ON ivcbarram.item_code = ivitemv1.item_code", "LEFT OUTER JOIN ivbrandm  on ivitemv1.brand_code = ivbrandm.brand_code", "INNER JOIN ivunitd on ivitemv1.item_code = ivunitd.item_code", "             and  ivunitd.unit_code = ivitemv1.unit_code    ", "LEFT JOIN vw_iventrdp on ivitemv1.item_code = vw_iventrdp.item_code", "             ORDER BY ivitemv1.item_name, ivitemv1.existencia DESC"}
        Me.xlk_item_code.SQLTab = New String() {"select", " ivreferm.refer,", "ivitemv1.item_name,", "ivitemv1.price,", "ivitemv1.existencia ,", "ivitemv1.Ubicacion,", "cpprovm.prov_name", "from ivreferm", "inner join ivitemv1", "on ivitemv1.item_code = ivreferm.item_code", "inner join cpprovm", "on cpprovm.prov_code = ivreferm.prov_code"}
        ...
        Me.xlk_item_code.VisParameters = New String() {"Producto=item_code", "Nombre=item_name", "Unidad=unit_code", "Precio=price", "Precio+ITBIS=precioitbis", "Existencia=existencia", "Ult Compra=dia", "Controlado=prd_controlado", "Ubicacion=Ubicacion"}
        ...
        'xgcol_usocontinuo
        '
        Me.xgcol_usocontinuo.FalseValue = CType(0, Short)
        Me.xgcol_usocontinuo.HeaderText = "..."
        Me.xgcol_usocontinuo.MappingName = "ind_cobertura"
        Me.xgcol_usocontinuo.NullValue = 0
        Me.xgcol_usocontinuo.TrueValue = CType(1, Short)
        Me.xgcol_usocontinuo.UseCustomCellFormat = False
        Me.xgcol_usocontinuo.Width = 25
        '
        'Label16
        '
        ...
        Me.lblitem_name.Size = New System.Drawing.Size(128, 20)
        ...
        Me.Label18.Location = New System.Drawing.Point(592, 624)
        ...
        Me.lbllocalizacion.Location = New System.Drawing.Point(672, 624)
        ...
        Me.Label20.Location = New System.Drawing.Point(810, 606)
        ...
        Me.lblexistencia.Location = New System.Drawing.Point(816, 634)
        Me.lblexistencia.Name = "lblexistencia"
        Me.lblexistencia.Size = New System.Drawing.Size(88, 32)
        ...
        Me.Label35.Location = New System.Drawing.Point(560, 648)
        ...
        Me.lblVencimiento.Location = New System.Drawing.Point(672, 648)
        ...
        Me.lblprov_name.Size = New System.Drawing.Size(400, 20)
        ...
        Me.btnSetHold.Location = New System.Drawing.Point(216, 680)
        ...
        Me.btnExistencia.Enabled = False
        ...
        'xtxsusta
        '
        Me.xtxsusta.Anchor = CType((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        Me.xtxsusta.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D
        Me.xtxsusta.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ftfactd.sustancias"))
        Me.xtxsusta.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!)
        Me.xtxsusta.ForeColor = System.Drawing.SystemColors.ControlText
        Me.xtxsusta.Location = New System.Drawing.Point(200, 625)
        Me.xtxsusta.Name = "xtxsusta"
        Me.xtxsusta.Size = New System.Drawing.Size(272, 20)
        ...
        Me.lblentrada.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ftfactd.entrada"))
        Me.lblentrada.Font = New System.Drawing.Font("Microsoft Sans Serif", 18.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.lblentrada.ForeColor = System.Drawing.Color.Blue
        Me.lblentrada.Location = New System.Drawing.Point(920, 634)
        Me.lblentrada.Name = "lblentrada"
        Me.lblentrada.Size = New System.Drawing.Size(80, 32)
        Me.lblentrada.TabIndex = 29
        '
        'Label15
        '
        ...
        Me.Label15.Location = New System.Drawing.Point(920, 606)
        ...
        'DataColumn91
        '
        Me.DataColumn91.ColumnName = "ncf_type"
        Me.DataColumn91.DataType = GetType(System.Int32)
        '
        'i_ptvfact01
        '
...
#End Region
        ...
        Try
            ...
            Or e.AcceptedAction = LibxConnectionActions.Edit Then
                If Val(Me.xcbo_fact_status.currValue.ToString.Trim) <> Val(EstatusDocumentosEnum.enEspera) Then   'HOLD Then
                    ...
                    Or Val(Me.xcbo_fact_status.currValue.ToString.Trim) = Val(EstatusDocumentosEnum.DomicilioPendiente) _
                    Or Val(Me.xcbo_fact_status.currValue.ToString.Trim) = Val(EstatusDocumentosEnum.PendientePreparar) Then
                        '// Rebajar Inventario
                    ...
                    AndAlso isDomicilio = False Then
                        ...
                        '// marcar como impreso
                        If Not LibX.IsNull(LibXConnector1.CurrentDataRow!fact_number) And LibXConnector1.CurrentDataRow!fact_impresa = 0 Then
    ...
    Private Sub i_ptvfact01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            isDomiciMide = CType(System.Configuration.ConfigurationSettings.AppSettings.Get("LibxMedirDomicilio"), Boolean)
            ...
            verEntrada = CType(System.Configuration.ConfigurationSettings.AppSettings.Get("LibxVerEntrada"), Boolean)
            ...
            oSeguimiento = New SeguimientoAsegurado
            oSeguimientos = New CollectionSeguimientoAsegurado
    ...
    Private Sub LibXGrid1_CellValidate(ByVal sender As Object, ByVal e As LibX.LibXGrid.LibXGridCellValidateEventArgs) Handles LibXGrid1.CellValidate
        ...
        Try
            If LibXConnector1.IsDataEditing = True Then
                ...
                'If e.cell = LibXGrid1.GetColNum(xgcol_usocontinuo) AndAlso LibXGrid1.GetValue(e.row, xgcol_usocontinuo).Trim = "True" Then
                '    If CallSeguimiento(LibXGrid1.GetValue(gColitem_code)) Then
                '    End If
                'End If
                ...
                If e.cell = Me.gColQty.Column Or e.cell = Me.gColUnit_code.Column Then
                    ...
                    If (oDocumento.AfectaOtrosDocumentos = False OrElse oDevolucion.Serial > 0) _
                    And LibXConnector1.CurrentAction <> LibxConnectionActions.Edit Then
                ...
                If e.cell = Me.gColDescuento.Column Then
                    ...
                    If Descuento > 0 Then
                        Importe = Val(LibXGrid1.GetValue(e.row, gColPrecio)) * Val(LibXGrid1.GetValue(e.row, gColQty))
    ...
    Private Sub LibXConnector1_InsertingRow(ByVal sender As Object, ByVal e As LibX.Data.AdpaterRowUpdatingEventArgs) Handles LibXConnector1.InsertingRow
        Try
            ...
            If e.UpdatingArgs.StatementType = StatementType.Insert Then
                ...
                Select Case oClienteDomicilio.FormaPago
                    Case "CXC"
                        e.UpdatingArgs.Row!fact_cond = 2
                    Case "TAR"
                        e.UpdatingArgs.Row!fact_cond = 3
                    Case "EFE", "CHK", "NC", "SEG", Nothing
                ...
                '        e.UpdatingArgs.Row!fact_cond = 3 'TODO Condicion verificar
                '    Else
                '        If oClienteDomicilio.FormaPago = "TAR" Then
                ...
                If Me.xtxt_type_code.Text = "DEV" And mTotalSeguro > 0 Then
                    If Me.xtxt_fact_total.Text = mTotalFacturadoSeguro And Val(LibXConnector1.CurrentDataRow!seg_amount.ToString.Trim) <> mTotalSeguro Then
                        e.UpdatingArgs.Row!seg_amount = mTotalSeguro
                    End If
                End If
                ''//Para el monitoreo de los domicilio, esto se envian a un estodo de pendiente preparar
                ''//y asi se despliegan en la pantallade monitoreo
                If e.UpdatingArgs.Row!fact_status = Val(EstatusDocumentosEnum.Pendiente) And isDomiciMide = True _
                   And (Not LibX.IsNull(LibXConnector1.CurrentDataRow!fact_inddomicilio) AndAlso LibXConnector1.CurrentDataRow!fact_inddomicilio = 1) Then
                    e.UpdatingArgs.Row!fact_status = EstatusDocumentosEnum.PendientePreparar
                End If
            End If
    ...
    Private Sub EliminarDominicio(ByVal pftserial_no As Integer)
        ...
        ''Xdelete = New LibX.Data.XDeleteStmt("ftdomimseg")
        ''Xdelete.Fields("ftserial_no") = pftserial_no
        ''Xdelete.Execute()
    ...
    Private Sub xlk_type_code_AfterSetValues(ByVal sender As Object, ByVal e As LibX.LookupValuesEventArgs) Handles xlk_type_code.AfterSetValues
        Try
            ...
            If LibXConnector1.IsDataEditing = True Then
                ...
                '// Editar precio en SEGURO EMR - 16/11/2016
                Me.gColPrecio.ReadOnly = Not (e.row!type_code = "FSG")
                Me.gColPrecio.isReadOnly = Not (e.row!type_code = "FSG")
                ...
                If oDocumento.AfectaSeguroMedico = True Then
                    ...
                    '// Editar precio en SEGURO EMR - 16/11/2016
                    Me.gColPrecio.ReadOnly = False
                    Me.gColPrecio.isReadOnly = False

                    xgcol_usocontinuo.ReadOnly = False
                    'xgcol_usocontinuo.Width = 25


                    '// No permitir descuentos en el detalle
                    Me.xtxt_descuento.Enabled = False
                    Me.xtxt_descuento.Text = "0.00"
                    Me.xtxt_descuento.BackColor = System.Drawing.SystemColors.Control
                    Me.gColDescuento.ReadOnly = True
                    Me.gColDescuento.isReadOnly = True
                    If oClienteAsegurado.Poliza.Trim = "" Then
                        ''Me.xtxt_type_code.Text = e.row!type_code.ToString()
                        Me.xtxt_type_code_Validated(Me, New EventArgs)
                    End If
                ...
                Else
                    ...
                    xtxt_bus_name.Text = String.Empty
                    xtxresponsable.Text = String.Empty

                    Me.xtxt_seg_amount.Text = String.Empty
                    xgcol_usocontinuo.ReadOnly = True
                    'xgcol_usocontinuo.Width = 0
                End If
                ...
                Else
                    If oDocumento.AfectaOtrosDocumentos = True Then
                        ...
                        If oFact03.ShowDialog(oDevolucion) = DialogResult.OK Then
                            ...
                            'If Val(LibXConnector1.CurrentDataRow!ftserial_no.ToString.Trim) > 0 Then
                            'codio bart
                            If oDevolucion.TipoDocumento = "FSG" Then
                                ...
                                '/// buscar todos los productos de la factura
                                BuscarProductos()
                            Else
                                mTotalSeguro = 0
                            End If
                    ...
                    If oDocumento.AfectaSeguroMedico = True And Not IsNull(LibXConnector1.CurrentDataRow!type_code) AndAlso _
                                                                    LibXConnector1.CurrentDataRow!type_code = "DEV" And _
                                                                    Not LibX.IsNull(mPolizaAsegurado) Then
                        oClienteAsegurado.Poliza = oDevolucion.Poliza.ToString.Trim
                        If Val(oClienteAsegurado.Poliza) > 0 And Val(oClienteAsegurado.CompaniaID) = 0 Then
                            oClienteAsegurado.CompaniaID = LibX.Data.Manager.GetScalar("select cia_serial from sgasegm where aseg_poliza ='" & oDevolucion.Poliza.ToString.Trim & "'")
                        End If
                        oClienteAsegurado.Load()
                    Else
                        If oDocumento.AfectaSeguroMedico = True And Not IsNull(LibXConnector1.CurrentDataRow!type_code) AndAlso _
                                                                        LibXConnector1.CurrentDataRow!type_code <> "DEV" Then
            ...
            If LibXConnector1.IsDataEditing = True Then
                If oDocumento.AfectaOtrosDocumentos = True AndAlso oDevolucion.Serial > 0 Then
                    e.SQL = "select DISTINCT ftfactd.item_code,ftfactd.suc_code, " & _
                            ...
                            "costo purch_cost, prov_name,brand_name, ftfactd.dscto, ftfactd.price+ftfactd.itbis precioitbis,0 disc_pct,sustancias,ivitemv1.dia from ivitemv1" & _
                ...
                'Bart error que se generaba al hacer devoluciones
                Dim m_row As Integer = LibXGrid1.CurrentCell.RowNumber
                If Len(LibXGrid1.GetValue(gColitem_code).Trim) >= 8 And IsNumeric(LibXGrid1.GetValue(m_row, gColitem_code).Trim) Then
                    e.SQL = e.SQL.Replace("ivitemv1.item_code = '", "ivcbarram.barra = '")
                End If

                'If oDevolucion.Serial = 0 Then
                '    If Len(LibXGrid1.GetValue(LibXGrid1.currentRowNum, gColitem_code).Trim) >= 8 And IsNumeric(LibXGrid1.GetValue(LibXGrid1.currentRowNum, gColitem_code).Trim) Then
                '        e.SQL = e.SQL.Replace("ivitemv1.item_code = '", "ivcbarram.barra = '")
                '    End If
                'End If
            End If
    ...
    Private Sub Distribuye_descuento(Optional ByVal PorcDescuento As Integer = 0, Optional ByVal PorcCobertura As Integer = 0)
        ...
        Try
            If Val(Me.xtxt_descuento.Text.Trim) > 0 Then
                ...
                '// MontoSeguro = Val(ftfactd.Compute("sum(importe)", "1=1").ToString.Trim)
                '// MontoBruto = Val(ftfactd.Compute("sum(qty)*sum(price)", "aplica_dscnt=1").ToString.Trim)

                For Each oRow As DataRow In ftfactd.Select("aplica_dscnt=1", "disc_pct DESC")
                    If Val(orow!qty.tostring.Trim) * Val(orow!price.tostring.Trim) > 100 Then
                        MontoBruto += Val(orow!qty.tostring.Trim) * Val(orow!price.tostring.Trim)
                    End If
                Next

                If MontoBruto < 200 Then
                    Return
                End If
                ...
                For Each oRow As DataRow In ftfactd.Select("aplica_dscnt=1", "disc_pct DESC")
                    ...
                    PorcDescuentoProd = Decimal.Round(((Val(oRow!qty.tostring.Trim) * Val(oRow!price.tostring.Trim))) * PorcDescuentoProd, 6)
                    PorcDescuentoDigi = Decimal.Round(((Val(oRow!qty.tostring.Trim) * Val(oRow!price.tostring.Trim))) * PorcDescuentoDigi, 6)
...
NEXT_ROW:
    ...
    Private Sub btnFreeHold_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFreeHold.Click
        ...
        Try
            ...
            With oParam
                ...
                .WhereToExecute = "ftfactm.type_code in  ('FPV','FSG','RCE','DEV','EST','FTS') and (ftfactm.fact_status = " & Val(EstatusDocumentosEnum.Pendiente).ToString.Trim & " or ftfactm.fact_status = " & Val(EstatusDocumentosEnum.PendientePreparar).ToString.Trim & ") and ftfactm.whse_code = " & WhDefault
            End With
    ...
    Private Sub LibXConnector1_SettingDefaulteditValues(ByVal sender As Object, ByVal e As LibX.SettingDefaultEditValues) Handles LibXConnector1.SettingDefaulteditValues
        ...
        Try
            ...
            If oDocumento.AfectaSeguroMedico = True AndAlso LibX.IsNull(Me.LibXConnector1.CurrentDataRow!aseg_poliza) = False Then
                ...
                oClienteAsegurado.CompaniaID = Me.LibXConnector1.CurrentDataRow!cia_serial
                oClienteAsegurado.Load()
            ...
            If Not e.row Is Nothing Then
                If LibXConnector1.IsDataEditing = False And LibXConnector1.HasRecords = True Then
                    If e.row!fact_status = Val(EstatusDocumentosEnum.Pendiente) _
                       Or e.row!fact_status = Val(EstatusDocumentosEnum.enEspera) _
                       Or e.row!fact_status = Val(EstatusDocumentosEnum.PendientePreparar) Then
                    ...
                    If Not LibX.IsNull(LibXConnector1.CurrentDataRow!type_code) Then
                        ...
                        End If
                    End If
                    If e.row!fact_status = Val(EstatusDocumentosEnum.PendientePreparar) Then
                        LibXConnector1.AllowPrint = True
                    End If
        ...
        Try
            ...
            Or e.UpdatingArgs.StatementType = StatementType.Update Then
                ...
                Or e.UpdatingArgs.StatementType = StatementType.Update Then
                    ...
                    '// SEGUIMIENTO
                    '// si se esta enviando a hold no guardar informacion de autorizacion
                    If oSeguimientos.Count > 0 Then
                        oSeguimientos.SetFacturaSerial(e.UpdatingArgs.Row!ftserial_no)
                        oSeguimientos.Update()
                    End If
                    '// END SEGUIMIENTO
    ...
    Private Sub SetFocusToGrid()
        Try
            ...
            'If LibXGrid1.getCurrentGridView.Count <= 0 Then
            '    '    If LibXGrid1.currentRowNum > 0 Then
            '    '        Exit Sub
            '    '    End If
            '    LibXGrid1.Focus(0, 0)
            'Else
    ...
    Private Sub xtxt_type_code_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles xtxt_type_code.Validated
        Try
            ...
            If LibXConnector1.IsDataEditing = True _
            And (LibXConnector1.CurrentAction = LibxConnectionActions.Add _
                Or LibXConnector1.CurrentAction = LibxConnectionActions.Edit) Then
        ...
        Try
            ...
            Or LibXConnector1.CurrentAction = LibxConnectionActions.Add Then
                For i As Integer = 0 To ftfactd.Rows.Count - 1
                    If i < ftfactd.Rows.Count Then
                        If (ftfactd.Rows(i).RowState <> DataRowState.Deleted And ftfactd.Rows(i).RowState <> DataRowState.Detached) AndAlso LibX.IsNull(ftfactd.Rows(i)!item_code) Then
    ...
    Private Sub LibXConnector1_ExecutingAction(ByVal sender As Object, ByVal e As LibX.ExecutingActionEventArgs) Handles LibXConnector1.ExecutingAction
        Try
            ...
            If e.Action = LibxConnectionActions.Cancel Then
                If Not LibXConnector1.CurrentDataRow Is Nothing AndAlso Not LibX.IsNull(LibXConnector1.CurrentDataRow!ftserial_no) Then
                    oBloqueoDocumento.BorrarBloqueo(LibXConnector1.CurrentDataRow!ftserial_no, LibXConnector1.CurrentDataRow!type_code)
                End If
            End If
    ...
    Private Sub xlk_item_code_CreatedGridColumns(ByVal sender As Object, ByVal e As LibX.CreatedGridColumnsEventArgs) Handles xlk_item_code.CreatedGridColumns
        ' Identify TempColumn object that is the DataGridComboBoxColumn's "child"
        Dim TempColumn As XEditTextBoxColumn = e.TStyle.GridColumnStyles(5)
        Dim TempColumn1 As XEditTextBoxColumn = e.TStyle.GridColumnStyles(3)

        '' EXISTENCIA
        TempColumn.UseCustomCellFormat = True
        AddHandler TempColumn.SetCellFormat, AddressOf SellFormat

        '' PRECIO
        TempColumn1.UseCustomCellFormat = True
        AddHandler TempColumn1.SetCellFormat, AddressOf SellFormat

    End Sub

    Public Sub SellFormat(ByVal sender As Object, ByVal e As LibX.XDataGridFormatCellEventArgs)
        If e.Column = 5 Then '// existencia
            e.BackColor = System.Drawing.Color.LightYellow
            e.TextFont = New Font("Arial", 16, FontStyle.Bold)
        End If

        If e.Column = 3 Then
            e.ForeColor = System.Drawing.Color.Blue
        End If
    End Sub

    Private Sub xlk_type_code_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles xlk_type_code.Enter

    End Sub

    Private Sub xlk_type_code_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles xlk_type_code.Click
        'xtxt_type_code.Focus()
    End Sub

    Private Sub xlk_type_code_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles xlk_type_code.Load
    ...
    Private Function CallSeguimiento(ByVal pitem_code As String) As Boolean
        Dim Retorno As Boolean = False
        Dim oFact06 As i_ptvfact06
        Dim oParam As LibX.LibxPrgParams

        If pitem_code.Trim = "" Then
            Return False
        End If

        oSeguimiento = oSeguimientos.GetbyProducto(pitem_code)

        If oSeguimiento Is Nothing Then
            oSeguimiento = New SeguimientoAsegurado
        End If

        oParam = New LibX.LibxPrgParams
        If oSeguimiento.FacturaSerial <= 0 Then
            oParam.initMode = LibxInitModes.Insert
        Else
            oParam.WhereToExecute = "ftfactd3.ftserial_no = " & oSeguimiento.FacturaSerial.ToString & _
                                    " and ftfactd3.item_code = '" & pitem_code.Trim & "'"
            oParam.initMode = LibxInitModes.Edit
        End If

        oSeguimiento.Fecha = xdt_fact_date.Value
        oSeguimiento.Cantidad = LibXGrid1.GetValue(gColQty)
        oSeguimiento.Producto = pitem_code
        oSeguimiento.Unidad = LibXGrid1.GetValue(gColUnit_code)
        oSeguimiento.Factor = Val(LibXGrid1.GetValue(gColFactor).ToString.Trim)

        LibX.App.CurrentPrgParams = oParam

        oFact06 = New i_ptvfact06
        If oFact06.ShowDialog(oSeguimiento) = DialogResult.OK Then
            oSeguimientos.AddByProducto(oSeguimiento)
            Retorno = True
        Else
            Retorno = False
        End If
    ...
    Private Sub xgcol_usocontinuo_BoolValueChanged(ByVal sender As Object, ByVal e As LibX.BoolValueChangedEventArgs) Handles xgcol_usocontinuo.BoolValueChanged
        If LibXConnector1.IsDataEditing = True Then
            'If e.cell = LibXGrid1.GetColNum(xgcol_usocontinuo) AndAlso LibXGrid1.GetValue(e.Row, xgcol_usocontinuo).Trim = "True" Then
    ...
    Private Sub BuscarProductos()
        ...
        'Dim oftfactm As DataRow

        'Try

        '    strSQL = "select * from ftfactm where ftserial_no = " & oDevolucion.Serial.ToString
        '    oftfactm = LibX.Data.Manager.GetDataRow(strSQL)

        '    If oftfactm Is Nothing Then
        '        Throw New ApplicationException("No se encontro el documento a devolver")
        '    End If

        '    strSQL = "select DISTINCT ftfactd.item_code,ftfactd.suc_code, " & _
        '                              "item_name, ftfactd.unit_code,ftfactd.factor, " & _
        '                              "ftfactd.price, ftfactd.qty , ftfactd.qty existencia, " & _
        '                              "ubicacion, ivitemv1.prov_code, aplica_dscnt,isnull(prd_controlado,0)prd_controlado ," & _
        '                              "costo purch_cost, prov_name,brand_name, ftfactd.dscto, ftfactd.price+ftfactd.itbis precioitbis, " & _
        '                              "(ftfactd.price*ftfactd.qty)+isnull(dscto,0)+isnull(ftfactd.itbis,0) as Importe, " & _
        '                              "(ftfactd.price*ftfactd.qty) as net_amt " & _
        '                              ",0 disc_pct,sustancias,ivitemv1.dia from ivitemv1" & _
        '                              " inner join ftfactd on ivitemv1.item_code = ftfactd.item_code " & _
        '                              " and ivitemv1.whse_code = ftfactd.whse_code " & _
        '                              " left outer join cpprovm " & _
        '                              " on cpprovm.prov_code = ivitemv1.prov_code" & _
        ...
        '    'strSQL = LibX.ConcatWherePart(strSQL, e.wherePart)

        '    strSQL = LibX.ConcatWherePart(strSQL, "ftfactd.ftserial_no = " & oDevolucion.Serial.ToString)
        '    oftfactd = LibX.Data.Manager.GetDataTable(strSQL, "ftfactd")

        '    Me.xtxt_fact_total.Text = oftfactm!fact_total.ToString()
        '    Me.xtxt_descuento.Text = oftfactm!descto.ToString()
        '    Me.xtxt_seg_amount.Text = oftfactm!seg_amount.ToString()
        '    Me.xtxt_itbis.Text = oftfactm!itbis.ToString()

        '    For Each oRow As DataRow In oftfactd.Rows
        '        DataSet1.Tables("ftfactd").ImportRow(oRow)
        '    Next
