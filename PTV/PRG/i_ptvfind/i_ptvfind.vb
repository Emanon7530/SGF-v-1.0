...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'ftsegrm
        '
        Me.ftsegrm.Columns.AddRange(New System.Data.DataColumn() {Me.DataColumn57, Me.DataColumn59, Me.DataColumn60, Me.DataColumn61, Me.DataColumn62, Me.DataColumn63, Me.DataColumn64, Me.DataColumn81, Me.DataColumn89})
        ...
        Me.xdt_ftfactm.Source = New String() {"SELECT", "ftfactm.ftserial_no,", "ftfactm.whse_code,", "ftfactm.dev_type,", "ftfactm.cotiz_serial,", "ftfactm.term_code,", "ftfactm.addr_code,", "ftfactm.vend_code,", "ftfactm.fact_number,", "ftfactm.fact_date,", "ftfactm.fact_total,", "ftfactm.descto,", "ftfactm.itbis,", "ftfactm.userid,", "ftfactm.fact_status,", "ftfactm.date_created,", "ftfactm.type_code,", "ftfactm.cust_code,", "ftfactm.fact_cond,", "ftfactm.bus_name,", "ftfactm.address,", "ftfactm.fact_nota,", "ftfactm.ftserial_afect,", "ftfactm.pay_adelant,", "ftfactm.phone,", "ftfactm.pay_mora,", "ftfactm.porc_comision,", "ftfactm.caja_code,", "ftfactm.caje_code,", "ftfactm.fact_inddomicilio,", "ftfactm.fact_impresa,", "ftfactm.fact_ncf,", "cjtranrv.init_serial,", "cjtranrv.efectivo,", "cjtranrv.tarjeta,", "cjtranrv.credito,", "cjtranrv.notacredito,", "cjtranrv.cheque,", "cjtranrv.seguro,", "ftafectm.ftserial_no afect_serial,", "ftafectm.fact_number afect_number,", "ftsegrm.aseg_poliza,", "ftfactm.seg_amount,", "ftfactm.prov_code,", "ftfactm.cust_serial,", "ftfactm.fact_time", "from ftfactm ", "WITH (HOLDLOCK, ROWLOCK) ", "left outer join cjtranrv  ", "on  ftfactm.ftserial_no = cjtranrv.ftserial_no ", "left outer join ftfactm ftafectm", "on ftfactm.ftserial_afect = ftafectm.ftserial_no", "left outer join ftsegrm", "on ftfactm.ftserial_no = ftsegrm.ftserial_no", "where ftfactm.ftserial_no in(select ftserial_no from ftfactd)"}
        ...
        Me.xdt_ftfactd.MasterDetailRelation = New String() {"ftserial_no=ftserial_no", "whse_code=whse_code"}
        Me.xdt_ftfactd.MasterTableName = Nothing
        Me.xdt_ftfactd.SerialColumnName = Nothing
        Me.xdt_ftfactd.Sort = Nothing
        Me.xdt_ftfactd.Source = New String() {"select ftfactd.*,", "ivitemv1.item_name,", "ivitemv1.existencia,", "ivitemv1.ubicacion,", "cpprovm.prov_name,", "aplica_dscnt,", "ivitemv1.disc_pct,", "ivitemv1.prd_controlado", "from ftfactd ", "inner join ivitemv1", "on ivitemv1.item_code = ftfactd.item_code", "and ivitemv1.whse_code = ftfactd.whse_code", "inner join cpprovm", "on ivitemv1.prov_code = cpprovm.prov_code"}
        ...
        Me.xdt_ftsegrm.MasterDetailRelation = New String() {"ftserial_no=ftserial_no"}
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(992, 240)
        ...
        Me.xkl_cliente.Location = New System.Drawing.Point(488, 110)
        ...
        Me.btnCustomer.Text = "..."
        Me.ToolTip1.SetToolTip(Me.btnCustomer, "Informacion del cliente")
        '
        'xlk_caje_code
        '
        ...
        Me.xchk_domicilio.Location = New System.Drawing.Point(616, 40)
        ...
        Me.xtxt_fact_total.Location = New System.Drawing.Point(616, 64)
        ...
        Me.xcbo_fact_status.FindInitialValue = "2"
        ...
        Me.Label10.Location = New System.Drawing.Point(504, 64)
        ...
        Me.Label13.Location = New System.Drawing.Point(507, 192)
        ...
        Me.xtxt_descuento.Location = New System.Drawing.Point(616, 96)
        ...
        Me.xtxt_itbis.Location = New System.Drawing.Point(616, 128)
        ...
        Me.xtxt_MontoNeto.Location = New System.Drawing.Point(616, 192)
        ...
        'btnSeguro
        '
        Me.btnSeguro.Location = New System.Drawing.Point(616, 160)
        ...
        Me.xtxt_seg_amount.Location = New System.Drawing.Point(642, 160)
        ...
        Me.Label26.Location = New System.Drawing.Point(538, 160)
        ...
        Me.xchk_fact_impresa.Location = New System.Drawing.Point(720, 40)
        ...
        Me.LibXGrid1.Location = New System.Drawing.Point(8, 272)
        Me.LibXGrid1.Name = "LibXGrid1"
        Me.LibXGrid1.ReadOnly = True
        Me.LibXGrid1.searchText = ""
        Me.LibXGrid1.showFooterBar = True
        Me.LibXGrid1.Size = New System.Drawing.Size(992, 280)
        ...
        Me.xlk_item_code.DestParameters = New String() {"item_code=item_code", "item_name=item_name", "unit_code=unit_code", "factor=factor", "existencia=existencia", "costo=purch_cost", "prov_name=prov_name", "ubicacion=ubicacion", "aplica_dscnt=aplica_dscnt", "disc_pct=disc_pct", "prd_controlado=prd_controlado"}
        ...
        Me.xlk_item_code.SqlString = New String() {"SELECT DISTINCT ivitemv1.item_code,item_name,ivitemv1.unit_code,", "                             ivunitd.factor,price,existencia,ivitemv1.prov_code,", "                            purch_cost,ubicacion,cpprovm.prov_name,", "                           aplica_dscnt,0 dscto,precioitbis,disc_pct,", "                           isnull(prd_controlado,0)prd_controlado", "FROM ivitemv1 ", "INNER JOIN cpprovm ON cpprovm.prov_code = ivitemv1.prov_code", "LEFT OUTER JOIN ivcbarram ON ivcbarram.item_code = ivitemv1.item_code", "INNER JOIN ivunitd on ivitemv1.item_code = ivunitd.item_code", "             and  ivunitd.unit_code = ivitemv1.unit_code    order by ivitemv1.ite" & _
        "m_name"}
        ...
        Me.lblitem_name.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ftfactd.item_name"))
        Me.lblitem_name.Location = New System.Drawing.Point(72, 608)
        Me.lblitem_name.Name = "lblitem_name"
        Me.lblitem_name.Size = New System.Drawing.Size(392, 20)
        ...
        Me.Label18.Location = New System.Drawing.Point(522, 608)
        ...
        Me.lbllocalizacion.Location = New System.Drawing.Point(600, 608)
        ...
        Me.Label20.Location = New System.Drawing.Point(744, 608)
        ...
        Me.lblexistencia.Location = New System.Drawing.Point(856, 608)
        ...
        Me.Label35.Location = New System.Drawing.Point(488, 632)
        ...
        Me.lblVencimiento.Location = New System.Drawing.Point(600, 632)
        ...
        Me.Label37.Location = New System.Drawing.Point(8, 632)
        ...
        Me.lblprov_name.Location = New System.Drawing.Point(72, 632)
        ...
        Me.ClientSize = New System.Drawing.Size(1010, 712)
        ...
        Me.Text = "SGF Punto de Venta(Modod Busqueda)"
...
#End Region
    ...
    Private Sub LibXConnector1_ExecutedAction(ByVal sender As Object, ByVal e As LibX.ExecutingActionEventArgs) Handles LibXConnector1.ExecutedAction
        ...
        Try
            ...
            If e.AcceptedAction = LibxConnectionActions.Find Then
                Me.xtxt_caja_code.Text = LibX.User.VendedorID
                    ...
                    AndAlso isDomicilio = False Then
                        Select Case oDocumento.SoloDomicilio
                            Case oDocumento.SoloDomicilio = True
                                'If oDocumento.CantCopias > 0 And LibXConnector1.CurrentDataRow!fact_inddomicilio = 1 Then
                                LibXConnector1.ReportObject.Copias = 1 ' oDocumento.CantCopias  '// Imprimir Directo
                                'End If
                            Case oDocumento.SoloDomicilio = False
                                'If oDocumento.CantCopias > 0 Then
                                LibXConnector1.ReportObject.Copias = 1 'oDocumento.CantCopias  '// Imprimir Directo
                                'End If
                        End Select
            ...
            'If e.Action = LibxConnectionActions.Print And Not LibX.IsNull(LibXConnector1.CurrentDataRow!fact_number) Then
            '    SetPrinted(LibXConnector1.CurrentDataRow!ftserial_no)
            'End If
    ...
    Private Sub i_ptvfact01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.xtxt_caja_code.Text = LibX.Data.Manager.GetScalar("select top 1 caja_code from cjinitm where init_status =1")
            Me.xtxt_caje_code.Text = LibX.Data.Manager.GetScalar("select top 1 vend_code from cjinitm where init_status =1")
            ...
            '''    oCajera = New Cajera(LibX.User.VendedorID)
            '''    hasCajas = oCajaAbierta.HayCajasAbiertas(oCajera.Code)
            '''Else
            ...
            '''If oCajaAbierta.GetAbiertaByCajeraID(LibX.User.VendedorID) = False Then
            '''    CloseProgram = True
            ...
            oCaja = New Caja(Me.xtxt_caja_code.Text)
    ...
    Private Sub LibXConnector1_SettingDefaultNewValues(ByVal sender As Object, ByVal e As LibX.SettingDefaultNewValues) Handles LibXConnector1.SettingDefaultNewValues
        ...
        Try
            ...
            Me.xcbo_fact_status.currValue = Val(EstatusDocumentosEnum.Cobrada)   '// Pendiente
    ...
    Private Function CalcularDescuentoDevolver(ByVal ftserial_no As Integer, ByVal item_code As String, ByVal qty As Integer, ByVal unidad As String)
        ...
        DescuentoUnidad = Descuento / oUnidadParam.Retorno.Cantidad
        ...
        DescuentoUnidad = DescuentoUnidad * oUnidadParam.Retorno.Cantidad
    ...
    Private Function ValidarExistenciaFactura() As Boolean
        ...
        Try
            ...
            '''    Descuento = Descuento / Existencia
            '''    Descuento = Descuento * Cantidad
            '''    LibXGrid1.SetValue(LibXGrid1.currentRowNum, gColDescuento, Descuento)
            '''End If
            ...
            If oDocumento.AfectaOtrosDocumentos = False OrElse (Not oDevolucion Is Nothing AndAlso oDevolucion.Serial > 0) Then
                If oUnidadParam.Retorno.Cantidad > Existencia Then
                    ...
                    If oAutorizar.isAutorization(oParamValidar) = False Then
                        ...
                        LibXGrid1.SetValue(LibXGrid1.currentRowNum, gColUnit_code, oUnidadParam.Retorno.Unidad)
                        LibXGrid1.SetValue(LibXGrid1.currentRowNum, gColPrecio, Precio)
                        Result = False
                    End If
                End If
            End If
            ...
            Or e.UpdatingArgs.StatementType = StatementType.Update Then
                ...
                If (LibX.IsNull(LibXConnector1.CurrentDataRow!fact_inddomicilio) = False _
                    ...
                    If oClienteDomicilio.Cambio > 0 AndAlso oClienteDomicilio.Cambio < Val(Me.xtxt_MontoNeto.Text.Trim) Then
                        Throw New ApplicationException("Vuelto del domicilio es menor que el valor de la factura!")
                    End If
                End If
    ...
    Private Sub CalcularNeto()
        ...
        Try
            ...
            If LibXConnector1.IsDataEditing = True AndAlso oDocumento.AfectaSeguroMedico = True Then
                CalcularSeguro()
                If Val(Me.xtxt_fact_total.Text) > 0 Then
                    Me.btnSeguro.Enabled = True
                End If
            End If
    ...
    ''''Private Sub btnCobrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ''''    Dim oParam As LibX.LibxPrgParams
    ''''    Dim oHold As i_fthold01
    ''''    Dim oFactura As i_fthold01.Factura
    ...
    ''''        oFactura = New i_fthold01.Factura
    ...
    ''''            .WhereToExecute = "ftfactm.type_code in  ('FPV','FSG','RCE','DEV','FTS','EST') and ftfactm.fact_status = " & Val(EstatusDocumentosEnum.Pendiente).ToString
    ''''        End With
        ...
        Try
            If LibXConnector1.IsDataEditing = True Then
                If oDocumento.AfectaOtrosDocumentos = True AndAlso oDevolucion.Serial > 0 Then
                    e.SQL = "select DISTINCT ftfactd.item_code," & _
                            ...
                            "costo purch_cost, prov_name, ftfactd.dscto, ftfactd.price+ftfactd.itbis precioitbis,0 disc_pct,sustancias from ivitemv1" & _
                ...
                Else
                    e.aditionalWhere = "ivitemv1.whse_code = " & WhDefault.ToString
    ...
    '''            'Me.xtxt_address.Text = oClienteDomicilio.Direccion
    ...
    Private Sub LibXConnector1_ChangeState(ByVal sender As Object, ByVal e As LibX.XChangeStateEventArgs) Handles LibXConnector1.ChangeState
        Try
            ...
            '''Me.btnVencimiento.Enabled = (e.isDataEditing = False And LibXConnector1.HasRecords = True)
            ...
            btnSeguro.Enabled = (e.isDataEditing)
    ...
    '''Private Sub btnSetHold_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    '''Private Sub btnFreeHold_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '''    Dim oParam As LibX.LibxPrgParams
    '''    Dim oHold As i_fthold01
    '''    Dim oFactura As i_fthold01.Factura
    ...
    '''            End If
    '''            .WhereToExecute = "ftfactm.type_code in  ('FPV','FSG','RCE','DEV','EST') and ftfactm.fact_status = " & Val(EstatusDocumentosEnum.enEspera).ToString.Trim
    '''        End With
    ...
    Private Sub LibXConnector1_AfterRowChange(ByVal sender As Object, ByVal e As LibX.XRowChangeEventArgs) Handles LibXConnector1.AfterRowChange
        Dim mTipo As String
        Try
            '''Me.btnVencimiento.Enabled = (LibXConnector1.IsDataEditing = False And LibXConnector1.HasRecords = True)
    ...
    Private Sub LibXConnector1_InsertedRow(ByVal sender As Object, ByVal e As LibX.Data.AdpaterRowUpdatedEventArgs) Handles LibXConnector1.InsertedRow
        ...
        Try
            ...
            If oClienteDomicilio.FormaPago = "TAR" Then
                If Val(Me.xtxt_descuento.Text) > 0 And Val(mConfig.GetDSCTO) > 0 And Val(mConfig.GetDsctoTar) > 0 Then
                    dst = (Me.xtxt_fact_total.Text * (mConfig.GetDsctoTar / 100))
                    dst = dst.ToString("###,###,###.##")
            ...
            Or e.UpdatingArgs.StatementType = StatementType.Update Then
                ...
                'If e.UpdatingArgs.StatementType = StatementType.Insert _
                'Or e.UpdatingArgs.StatementType = StatementType.Update Then
                If Not LibX.IsNull(e.UpdatingArgs.Row!fact_inddomicilio) AndAlso e.UpdatingArgs.Row!fact_inddomicilio = 1 Then
    ...
    '''Private Sub btnDomicilios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '''    Dim oParam As LibX.LibxPrgParams
    ...
    '''            .WhereToExecute = "ftfactm.fact_status = " & Val(EstatusDocumentosEnum.DomicilioPendiente).ToString
    '''        End With
    ...
    Private Sub LibXGrid1_CellKeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles LibXGrid1.CellKeyPress
        ...
        'Try
        '    If LibXConnector1.IsDataEditing = True Then
        '        '// guardar la ultima tecla presionada en el grid
        ...
        '        '// Shirt + Plus = Aumentar Cantidad
        '        '// Shirt + Minus = Disminuir Cantidad
        '        If e.KeyCode = Keys.Add AndAlso e.Shift = True Then
        '            If LibXGrid1.GetValue(LibXGrid1.currentRowNum, gColitem_code) <> "" Then
        '                Qty = Val(LibXGrid1.GetValue(LibXGrid1.currentRowNum, gColQty).Trim)
        '                Qty += 1
        '                LibXGrid1.SetValue(LibXGrid1.currentRowNum, gColQty, Qty)
        '                e.Handled = True
        '                LibXGrid1.Focus(0, 9)
        '            End If
        '        End If

        '        '// Shirt + Insert = Insertar Linea
        '        If e.KeyCode = Keys.Insert AndAlso e.Shift = True Then

        '        End If

        '        '// Shift + Delete = Borrar Linea
        '        If e.KeyCode = Keys.Delete AndAlso e.Shift = True Then
        '            If LibXGrid1.currentRowNum <= ftfactd.Rows.Count Then
        '                ftfactd.Rows(LibXGrid1.currentRowNum).Delete()
        '            End If
        '        End If
    ...
    Private Sub btnVencimiento_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim oParam As LibX.LibxPrgParams
        Try
            ...
            With oParam
                ...
                .IsFromOther = False
                '.initMode = LibxInitModes.Edit
                .WhereToExecute = "doc_serial = " & LibXConnector1.CurrentDataRow!ftserial_no & " and type_code = '" & xtxt_type_code.Text.Trim & "'"
            End With
    ...
    Private Sub LibXGrid1_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LibXGrid1.CurrentCellChanged
