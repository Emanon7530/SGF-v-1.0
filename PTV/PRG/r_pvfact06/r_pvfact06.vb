...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LibXConnector1.DataMember = "procliev"
        ...
        Me.LibXDbSourceTable1.Source = New String() {"select cust_code,item_code,whse_code", "from procliev "}
        Me.LibXDbSourceTable1.TableName = "procliev"
        ...
        Me.LibXLookup2.VisParameters = New String() {"Código=whse_code", "Descripción=whse_name"}
        ...
        Me.LibxDateTimePicker1.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "procliev.fecha_ini"))
        ...
        Me.LibxDateTimePicker2.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "procliev.fecha_fin"))
        ...
        'cust_name
        '
        Me.cust_name.Location = New System.Drawing.Point(208, 136)
        Me.cust_name.Name = "cust_name"
        Me.cust_name.ReadOnly = True
        Me.cust_name.Size = New System.Drawing.Size(200, 20)
        Me.cust_name.TabIndex = 35
        ...
        Me.LibXLookup1.VisParameters = New String() {"Código=cust_code", "Descripción=cust_name"}
        ...
        Me.LibXLookup3.DestParameters = New String() {"item_code=item_code", "item_name=item_name"}
        Me.LibXLookup3.FilterField = Nothing
        Me.LibXLookup3.IgnoreFindInBrowseMode = False
        Me.LibXLookup3.isCanceled = False
        Me.LibXLookup3.Location = New System.Drawing.Point(408, 160)
        Me.LibXLookup3.LookCaption = "Producto"
        ...
        Me.LibXLookup3.SrcParameters = New String() {"item_code=item_code"}
        Me.LibXLookup3.TabIndex = 37
        Me.LibXLookup3.TableName = "ivitemm"
        ...
        Me.LibXLookup3.VisParameters = New String() {"Código=item_code", "Descripción=item_name"}
        Me.LibXLookup3.WhereCondition = Nothing
        Me.LibXLookup3.WhereParameters = Nothing
        '
        'item_name
        '
        Me.item_name.Location = New System.Drawing.Point(208, 160)
        Me.item_name.Name = "item_name"
        Me.item_name.ReadOnly = True
        Me.item_name.Size = New System.Drawing.Size(200, 20)
        Me.item_name.TabIndex = 38
        ...
        Me.XTextBox3.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "procliev.whse_code"))
        ...
        Me.XTextBox5.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "procliev.item_code"))
        ...
        Me.XTextBox5.Location = New System.Drawing.Point(112, 160)
        ...
        Me.XTextBox5.Size = New System.Drawing.Size(88, 20)
        Me.XTextBox5.StatusBarPanelDescripcion = Nothing
        Me.XTextBox5.TabIndex = 42
        Me.XTextBox5.Text = ""
        '
        'DataTable1
        '
        ...
        Me.DataTable1.TableName = "procliev"
        '
        'DataColumn1
        '
        ...
        Me.XTextBox4.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "procliev.cust_code"))
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            AxCrystalReport1 = New LibX.ReportLib("PTV", "r_pvfact06.rpt")
            ...
            With AxCrystalReport1
                ...
                If sWh <> "" Then
                    sWhere = String.Concat(sWhere, " and procliev.whse_code = ", sWh)
                End If

                If sCl <> "" Then
                    sWhere = String.Concat(sWhere, " and procliev.cust_code = ", sCl)
                End If

                If sIt <> "" Then
                    sWhere = String.Concat(sWhere, " and procliev.item_code = ", sIt)
                End If
