...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataSet1.Tables.AddRange(New System.Data.DataTable() {Me.repventav})
        '
        'repventav
        '
        Me.repventav.Columns.AddRange(New System.Data.DataColumn() {Me.DataColumn1, Me.DataColumn2, Me.DataColumn3, Me.DataColumn4, Me.DataColumn5, Me.DataColumn8, Me.DataColumn9, Me.DataColumn10, Me.DataColumn11, Me.DataColumn12, Me.DataColumn13, Me.DataColumn14, Me.DataColumn15, Me.DataColumn16, Me.DataColumn17, Me.DataColumn18, Me.DataColumn19, Me.DataColumn20, Me.DataColumn6})
        ...
        'TextBox1
        '
        Me.TextBox1.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "repventav.type_code"))
        ...
        Me.venta_name.Location = New System.Drawing.Point(144, 136)
        ...
        'TextBox3
        '
        Me.TextBox3.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "repventav.caja_code"))
        Me.TextBox3.Location = New System.Drawing.Point(88, 160)
        ...
        Me.caja_name.Location = New System.Drawing.Point(144, 160)
        ...
        Me.TextBox4.Location = New System.Drawing.Point(88, 184)
        ...
        Me.cajera_name.Location = New System.Drawing.Point(144, 184)
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            AxCrystalReport1 = New ReportLib("PTV", "r_ptvrcaja.rpt")
            ...
            With AxCrystalReport1
                sWhere = " 1=1 "
                    ...
                    If e.row!whse_code.ToString.Trim <> "" Then
                        sWhere = String.Concat(sWhere, " and resventas.whse_code = ", e.row!whse_code.ToString)
                    End If

                    If e.row!type_code.ToString.Trim <> "" Then
                        sWhere = String.Concat(sWhere, " and resventas.type_code = '", e.row!type_code.ToString & "'")
                    End If

                    If e.row!caja_code.ToString.Trim <> "" Then
                        sWhere = String.Concat(sWhere, " and resventas.caja_code = '", e.row!caja_code.ToString & "'")
                    End If

                    If e.row!caje_code.ToString.Trim <> "" Then
                        sWhere = String.Concat(sWhere, " and resventas.caje_code = '", e.row!caje_code.ToString & "'")
                    End If
