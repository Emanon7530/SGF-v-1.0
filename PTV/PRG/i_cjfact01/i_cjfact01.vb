    ...
    Private Sub AplicarCobro()
        ...
        Try
            ...
            AndAlso oDocumento.GenerarNCF = True Then
                ...
                End If
                If LibXConnector1.CurrentDataRow!type_code = "DEV" Then
                    NcfAnt = LibX.Data.Manager.GetScalar("select substring(fact_ncf,11,1) from ftfactm where ftserial_no = " & LibXConnector1.CurrentDataRow!ftserial_afect)
                ...
                (LibX.IsNull(LibXConnector1.CurrentDataRow!fact_inddomicilio) _
                    ...
                    If oDocumento.SoloDomicilio = True Then
                        If oDocumento.CantCopias > 0 And LibXConnector1.CurrentDataRow!fact_inddomicilio = 1 Then
                            LibXConnector1.ReportObject.Copias = oDocumento.CantCopias  '// Imprimir Directo
                        End If
                    Else
