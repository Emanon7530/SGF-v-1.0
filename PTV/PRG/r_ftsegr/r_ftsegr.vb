...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents sgciasm As System.Data.DataTable
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.sgciasm = New System.Data.DataTable
        ...
        CType(Me.sgciasm, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.DataSet1.Tables.AddRange(New System.Data.DataTable() {Me.ftfactm, Me.sgciasm, Me.ftsegrm})
        '
        'ftfactm
        '
        ...
        Me.Label5.Text = "VENTAS SEGURO MEDICO"
        ...
        'DataColumn14
        '
        Me.DataColumn14.Caption = "fecIni"
        Me.DataColumn14.ColumnName = "fecIni"
        Me.DataColumn14.DataType = GetType(System.DateTime)
        '
        'DataColumn15
        '
        Me.DataColumn15.Caption = "fecfin"
        Me.DataColumn15.ColumnName = "fecfin"
        ...
        CType(Me.sgciasm, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            AxCrystalReport1 = New ReportLib("PTV", "r_ftsegr.rpt")

            With AxCrystalReport1
                sWhere = " 1=1 "
                'sWhere = String.Concat(sWhere, " and  ftfactm.ftserial_no = ftsegrm.ftserial_no")
                ...
                If e.row!cia_serial.ToString.Trim <> "" Then
                    sWhere = String.Concat(sWhere, " and ftsegrm.cia_serial = ", e.row!cia_serial.ToString)
                End If

                If e.row!plan_serial.ToString.Trim <> "" Then
                    sWhere = String.Concat(sWhere, " and ftsegrm.plan_serial = '", e.row!plan_serial.ToString & "'")
                End If

                sWhere = String.Concat(sWhere, " and ftfactm.type_code in ('FSG') and ftfactm.fact_status = 2")

                '.ParameterFields(3) = String.Concat("whse_code;", Trim(wHse), ";TRUE")
