...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LibXDbSourceTable1.Source = New String() {"select ", "cpinvcem.prov_code,cpprovm.prov_type,cpinvcem.type_code", "from cpprovm inner join cpinvcem on cpprovm.prov_code = cpinvcem.prov_code"}
        ...
        Me.txtprov_code.Location = New System.Drawing.Point(96, 120)
        ...
        'prov_name
        '
        Me.prov_name.Location = New System.Drawing.Point(152, 120)
        ...
        Me.Label5.Text = "DOCUMENTOS VENCIDOS "
        ...
        Me.LibXCombo2.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.DataSet1, "cpinvcem.type_code"))
        ...
        Me.LibxDateTimePicker1.DataBindings.Add(New System.Windows.Forms.Binding("Value", Me.DataSet1, "cpinvcem.Fecha_fin"))
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            If Not IsNull(e.row!prov_code) Then
                sSuplidor = e.row!prov_code.ToString
            End If
            ...
            AxCrystalReport1 = New ReportLib("CXP", "r_cppaym06.rpt")
            ...
            With AxCrystalReport1
                ...
                If Trim(sFechaHasta) <> "" Then
                    sWhere = String.Concat(sWhere, "and cpinvcem.due_date<='", Trim(sFechaHasta), "'")
                End If

                If Trim(sSuplidor) <> "" Then
                    sWhere = String.Concat(sWhere, " and cpprovm.prov_code = ", Trim(sSuplidor))
                End If
                ...
                If Trim(sTipdoc) <> "" Then
                    sWhere = String.Concat(sWhere, " and cpinvcem.type_code = '", Trim(sTipdoc), "'")
                End If
