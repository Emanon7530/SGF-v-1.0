...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cpinvcem.PrimaryKey = New System.Data.DataColumn() {Me.DataColumn10}
        ...
        'DataColumn3
        '
        Me.DataColumn3.ColumnName = "type_prov"
        '
        'DataColumn4
        '
        Me.DataColumn4.ColumnName = "prov_name"
        '
        'DataColumn5
        '
        Me.DataColumn5.ColumnName = "type_name"
        '
        'DataColumn6
        '
        ...
        'DataColumn7
        '
        Me.DataColumn7.ColumnName = "prov_type"
        '
        'DataColumn8
        '
        ...
        'DataColumn9
        '
        Me.DataColumn9.ColumnName = "Fecha_Ini"
        '
        'DataColumn10
        '
        ...
        'DataColumn12
        '
        Me.DataColumn12.ColumnName = "doc_no"
        ...
        'DataColumn21
        '
        Me.DataColumn21.ColumnName = "excento"
        Me.DataColumn21.DataType = GetType(System.Decimal)
        '
        'DataColumn22
        '
        Me.DataColumn22.ColumnName = "impto"
        Me.DataColumn22.DataType = GetType(System.Decimal)
        '
        'DataColumn23
        '
        Me.DataColumn23.ColumnName = "invce_status"
        Me.DataColumn23.DataType = GetType(System.Int32)
        '
        'DataColumn24
        '
        Me.DataColumn24.ColumnName = "date_created"
        ...
        'DataColumn26
        '
        Me.DataColumn26.ColumnName = "invce_ncf"
        Me.DataColumn26.MaxLength = 20
        '
        'DataColumn27
        '
        Me.DataColumn27.ColumnName = "dev_serial"
        ...
        Me.Label5.Text = "LISTADO DE SUPLIDORES:"
        ...
        'Txtprov_code
        '
        Me.Txtprov_code.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "cpinvcem.prov_name"))
        Me.Txtprov_code.Location = New System.Drawing.Point(96, 64)
        Me.Txtprov_code.Name = "Txtprov_code"
        Me.Txtprov_code.Size = New System.Drawing.Size(128, 20)
        ...
        Me.LibXCombo1.Location = New System.Drawing.Point(96, 96)
        ...
        Me.Label6.Text = "Término :"
        Me.Label6.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        '
        'TextBox2
        '
        Me.TextBox2.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "cpinvcem.term_code"))
        Me.TextBox2.Location = New System.Drawing.Point(96, 128)
        ...
        'term_name
        '
        Me.term_name.Location = New System.Drawing.Point(168, 128)
        Me.term_name.Name = "term_name"
        Me.term_name.ReadOnly = True
        Me.term_name.Size = New System.Drawing.Size(232, 20)
        Me.term_name.TabIndex = 23
        Me.term_name.Text = ""
        '
        'LibXLookup2
        '
        ...
        Me.LibXLookup2.DestParameters = New String() {"term_code=term_code", "term_name=term_name"}
        Me.LibXLookup2.FilterField = Nothing
        Me.LibXLookup2.IgnoreFindInBrowseMode = False
        Me.LibXLookup2.isCanceled = False
        Me.LibXLookup2.Location = New System.Drawing.Point(400, 128)
        ...
        Me.LibXLookup2.VisParameters = New String() {"Código=term_code", "Nombre=term_name"}
        ...
        Me.ClientSize = New System.Drawing.Size(530, 208)
        Me.Controls.Add(Me.Label6)
        Me.Controls.Add(Me.TextBox2)
        Me.Controls.Add(Me.term_name)
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            '    sFechaHasta = CDate(e.row!Fecha_ini).ToString(LibX.Data.Manager.GetSaveDateFormat)
            'End If
            'If Not IsNull(e.row!prov_name) Then
            '    sProvee = e.row!prov_name.ToString
            'End If
            ...
            If Not IsNull(e.row!term_code) Then
                sTermi = e.row!term_code.ToString
            End If
            ...
            AxCrystalReport1 = New ReportLib("CXP", "r_cpprovm01.rpt")
            ...
            With AxCrystalReport1
                ...
                If Trim(Txtprov_code.Text) <> "" Then
                    sWhere = String.Concat(sWhere, " and cpprovm.prov_name like '", Txtprov_code.Text, "%'")
                End If


                'If Trim(sProvee) <> "" Then
                '    sWhere = String.Concat(sWhere, " and cpprovm.prov_name ", Trim(sProvee))
                'End If

                If Not IsNull(e.row!prov_type) Then
                    sWhere = String.Concat(sWhere, " and cpprovm.prov_type = ", Trim(e.row!prov_type.ToString))
                End If

                If Not IsNull(e.row!term_code) Then
                    sWhere = String.Concat(sWhere, " and cpprovm.term_code = '", Trim(e.row!term_code.ToString), "'")
                End If
