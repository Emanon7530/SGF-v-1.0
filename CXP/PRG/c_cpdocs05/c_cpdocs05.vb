...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(0, 8)
        ...
        'cpinvcem
        '
        Me.cpinvcem.Columns.AddRange(New System.Data.DataColumn() {Me.DataColumn13, Me.DataColumn14, Me.DataColumn15, Me.DataColumn17, Me.DataColumn23, Me.DataColumn1, Me.DataColumn2, Me.DataColumn3})
        ...
        Me.LibXDbSourceTable1.Source = New String() {"select invce_serial,prov_code,type_code,doc_no,doc_date,", "(amount+itbis) amount,dev_serial", " from cpinvcem where type_code ='DVI' and invce_status = 2", "order by prov_code,doc_date"}
        ...
        Me.LibXGrid1.CaptionText = "Devoluciones"
        ...
        Me.LibXGrid1.Size = New System.Drawing.Size(384, 272)
        ...
        Me.XdataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.gColAplicar, Me.XEditTextBoxColumn1, Me.XDataGridLinkColumn1, Me.XEditTextBoxColumn3, Me.XEditTextBoxColumn6, Me.XEditTextBoxColumn8, Me.XEditTextBoxColumn9})
        ...
        Me.Label1.Location = New System.Drawing.Point(187, 333)
        ...
        Me.xtxmonto.Location = New System.Drawing.Point(278, 328)
        ...
        Me.xtxnc.Location = New System.Drawing.Point(280, 6)
        Me.xtxnc.Name = "xtxnc"
...
#End Region
        ...
        Try
            If LibXGrid1.EndEdit(gColAplicar, LibXGrid1.CurrentRowIndex, True) = False Then
                ...
                If cpinvcem.Rows(LibXGrid1.CurrentRowIndex)!Aplicar = 0 Then
                    mValor = mValor - cpinvcem.Rows(LibXGrid1.CurrentRowIndex)!amount
            ...
            If LibXConnector1.HasRecords = True Then
                If Not e.row Is Nothing Then
                    ...
                    If LibXConnector1.Parameters.Value > 0 Then
                        ...
                        mNcdoc = LibXConnector1.Parameters.Value
                    End If
                End If
            End If
        ...
        Try
            If LibXConnector1.IsDataEditing = True Then
                If e.KeyCode = Keys.F5 Then
                    If CType(xtxmonto.Text, Decimal) <> CType(xtxnc.Text, Decimal) Then
                        ncdv = MessageBox.Show("El monto aplicado es disferente al valor digitado", "Descuento", MessageBoxButtons.OKCancel)
                        If ncdv = System.Windows.Forms.DialogResult.Cancel Then
                            Return
                        End If
                    End If
                    ...
                    For Each oRow As DataRow In DataSet1.Tables("cpinvcem").Rows
                        If oRow!Aplicar = 1 Then
                            ...
                            xUpdate.FieldsSet("nc_number") = mNcdoc
                            xUpdate.FieldsSet("nc_amount") = CType(xtxmonto.Text, Decimal)
                            'xUpdate.FieldsSet("nc_date") = LibX.Data.Manager.Connection.GetDate.ToString("d")
                            xUpdate.Fields("dev_serial") = oRow!dev_serial
                            xUpdate.Execute()

                            xDelete = New LibX.Data.XDeleteStmt("cpinvcem")
                            xDelete.Fields("invce_serial") = oRow!invce_serial
                            xDelete.Execute()
                        End If
                    Next
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Try
            ...
            For Each oRow As DataRow In DataSet1.Tables("cpinvcem").Rows
                If oRow!Aplicar = 1 Then
                    mValor = Me.xtxmonto.Text
                    xUpdate = New LibX.Data.XUpdateStmt("ivdevolm")
                    xUpdate.FieldsSet("nc_amount") = mValor
                    xUpdate.FieldsSet("nc_number") = mNcdoc
                    'xUpdate.FieldsSet("nc_date") = LibX.Data.Manager.Connection.GetDate.ToString("d")
                    xUpdate.Fields("dev_serial") = oRow!dev_serial
                    xUpdate.Execute()
