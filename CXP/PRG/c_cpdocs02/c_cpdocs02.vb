...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(664, 200)
        ...
        Me.LibXCombo4.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.DataSet1, "ftfactm.type_code"))
        ...
        Me.LibXCombo4.Location = New System.Drawing.Point(88, 40)
        ...
        'rdb_Contado
        '
        Me.rdb_Contado.Location = New System.Drawing.Point(200, 90)
        ...
        Me.xdt_FechaFin.Location = New System.Drawing.Point(88, 114)
        ...
        Me.xdt_FechaInicio.Location = New System.Drawing.Point(88, 90)
        ...
        'xlk_bus_name
        '
        Me.xlk_bus_name.AlternateFieldSearch = Nothing
        Me.xlk_bus_name.BeginCheck = False
        Me.xlk_bus_name.CheckText = Nothing
        Me.xlk_bus_name.ComboMode = False
        ...
        Me.xlk_bus_name.isCanceled = False
        ...
        Me.xlk_bus_name.PopupSize = New System.Drawing.Size(0, 0)
        Me.xlk_bus_name.ShowFilter = True
        ...
        Me.LibXDbSourceTable1.Source = New String() {"select distinct ftfactm.type_code,ftfactm.fact_number,ftfactm.suc_code,ftfactm.fa" & _
        "ct_date,", "ftfactm.fact_status, ftfactm.phone,ftfactm.cust_code,", "ftseriem.serie_number,ftfactm.vend_code,ftfactd.item_code,", "ftfactm.bus_name,cccustm.cust_name,", "ivitemm.item_name,ftfactd.price,ftfactm.fact_total,ftfactm.fact_cond,ftserial_afe" & _
        ...
        Me.TextBox6.Location = New System.Drawing.Point(88, 138)
        ...
        'xlk_item_name
        '
        Me.xlk_item_name.AlternateFieldSearch = Nothing
        Me.xlk_item_name.BeginCheck = False
        Me.xlk_item_name.CheckText = Nothing
        Me.xlk_item_name.ComboMode = False
        ...
        Me.xlk_item_name.isCanceled = False
        ...
        Me.xlk_item_name.PopupSize = New System.Drawing.Size(0, 0)
        Me.xlk_item_name.ShowFilter = True
        ...
        Me.xlk_item_name.TabStop = False
        ...
        Me.Label7.Location = New System.Drawing.Point(2, 162)
        ...
        Me.TextBox7.Location = New System.Drawing.Point(88, 162)
        ...
        'rdb_Credito
        '
        Me.rdb_Credito.Location = New System.Drawing.Point(200, 114)
        ...
        Me.xlk_vend_code.Location = New System.Drawing.Point(288, 66)
        ...
        'vend_name
        '
        Me.vend_name.Location = New System.Drawing.Point(128, 66)
        ...
        Me.TextBox11.Location = New System.Drawing.Point(88, 66)
        ...
        Me.Label11.Location = New System.Drawing.Point(23, 66)
        ...
        Me.LibXGrid1.Location = New System.Drawing.Point(8, 224)
        Me.LibXGrid1.Name = "LibXGrid1"
        Me.LibXGrid1.ReadOnly = True
        Me.LibXGrid1.searchText = ""
        Me.LibXGrid1.showFooterBar = True
        Me.LibXGrid1.Size = New System.Drawing.Size(784, 296)
        ...
        Me.XEditTextBoxColumn4.HeaderText = "Sucursal"
        Me.XEditTextBoxColumn4.ImageList = Nothing
        Me.XEditTextBoxColumn4.isReadOnly = False
        Me.XEditTextBoxColumn4.MappingName = "suc_code"
        ...
        Me.xedSerial_afect.TabStop = True
        ...
        Me.btnVisualizar.Location = New System.Drawing.Point(8, 552)
        ...
        Me.btnPagos.Location = New System.Drawing.Point(88, 552)
        ...
        Me.btnCliente.Location = New System.Drawing.Point(168, 552)
        ...
        Me.btnCobros.Location = New System.Drawing.Point(248, 552)
        ...
        Me.btnRelacionado.Location = New System.Drawing.Point(328, 552)
        ...
        Me.btnSeries.Location = New System.Drawing.Point(408, 552)
        ...
        'DataColumn40
        '
        Me.DataColumn40.Caption = "suc_code"
        Me.DataColumn40.ColumnName = "suc_code"
        Me.DataColumn40.DataType = GetType(System.Int32)
        '
        'c_cpdocs02
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(804, 590)
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            SelectStmt = String.Concat("select distinct ftfactm.type_code,ftfactm.fact_number,ftfactm.suc_code,ftfactm.fact_date,", _
            ...
            If LibX.IsNull(xdt_FechaInicio.Value) = False Then
                SelectStmt &= " and ftfactm.fact_date between '" & CDate(xdt_FechaInicio.Value).ToShortDateString & _
                              "' and '" & CDate(xdt_FechaFin.Value).ToShortDateString & "'"
            End If

            oTable = LibX.Data.Manager.GetDataTable(SelectStmt)
            oTable.TableName = "ftfactd"
            ''''DataCol(0) = oTable.Columns("type_code")
            ''''DataCol(1) = oTable.Columns("fact_number")
            ''''oTable.PrimaryKey = DataCol
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRelacionado.Click, mnuRelacionado.Click, xlnk_type_code.LinkeClicked
        ...
        Try
            ...
            oParam.WhereToExecute = "ftfactm.ftserial_afect = " & LibXGrid1.GetValue(LibXGrid1.CurrentRowIndex, xedSerial_no).ToString
            LibX.App.CurrentPrgParams = oParam
    ...
    Private Sub xbln_fact_cond_SetCellFormat(ByVal sender As Object, ByVal e As LibX.XDataGridFormatCellEventArgs) Handles xbln_fact_cond.SetCellFormat, XEditTextBoxColumn1.SetCellFormat, XEditTextBoxColumn2.SetCellFormat, XEditTextBoxColumn3.SetCellFormat, xlnk_bus_name.SetCellFormat, xlnk_cust_code.SetCellFormat, xlnk_fact_number.SetCellFormat, xlnk_fact_total.SetCellFormat, xlnk_type_code.SetCellFormat, xed_status_name.SetCellFormat
        Try
            ...
            If LibXGrid1.GetValue(e.RowNumber, xlnk_type_code) = "FCT" Then
                If LibXGrid1.GetValue(e.RowNumber, xbln_fact_cond) = False Then
