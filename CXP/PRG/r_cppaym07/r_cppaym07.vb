...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataColumn2.Caption = "prov_code"
        ...
        Me.LibXDbSourceTable1.Source = New String() {"select cpinvcem.prov_code,cpprovm.prov_type", "from cpprovm inner join cpinvcem on cpprovm .prov_code = cpinvcem.prov_code"}
        ...
        Me.DataTable2.TableName = "cpinvcem "
        '
        'DataColumn4
        '
        ...
        'txtcust_code
        '
        Me.txtcust_code.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "cpinvcem .prov_code"))
        ...
        'prov_name
        '
        Me.prov_name.Location = New System.Drawing.Point(168, 116)
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            AxCrystalReport1 = New ReportLib("CXP", "r_cppaym07.rpt")
            ...
            With AxCrystalReport1
                ...
                If Trim(sFechaHasta) <> "" Then
                    sWhere = String.Concat(sWhere, "and (cpopend.last_pay_date >='", Trim(sFechaHasta), "' or cpinvcem.invce_status = 1)")
                End If
                ...
                If Trim(sProvee) <> "" Then
                    sWhere = String.Concat(sWhere, " and cpprovm.prov_code = ", Trim(sProvee))
                End If
