...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataTable1.TableName = "cppaymm"
        '
        'DataColumn1
        '
        ...
        Me.DataColumn3.Caption = "prov_code"
        ...
        'DataColumn5
        '
        Me.DataColumn5.ColumnName = "paym_number"
        '
        'DataColumn6
        '
        Me.DataColumn6.ColumnName = "prov_type"
        Me.DataColumn6.MaxLength = 6
        '
        'DataColumn7
        '
        Me.DataColumn7.ColumnName = "chequera"
        '
        'LibXDbSourceTable1
        '
        ...
        Me.LibXDbSourceTable1.Source = New String() {"select ", "cppaymm.prov_code,cpprovm.prov_type,suc_code", "from cpprovm inner join cppaymm on cppaymm.prov_code = cpprovm.prov_code"}
        ...
        Me.Fecha_ini.DataBindings.Add(New System.Windows.Forms.Binding("Value", Me.DataSet1, "cppaymm.Fecha_ini"))
        ...
        'txtprov_code
        '
        Me.txtprov_code.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "cppaymm.prov_code"))
        Me.txtprov_code.Location = New System.Drawing.Point(96, 136)
        Me.txtprov_code.Name = "txtprov_code"
        Me.txtprov_code.Size = New System.Drawing.Size(88, 20)
        Me.txtprov_code.TabIndex = 13
        Me.txtprov_code.Text = ""
        '
        'prov_name
        '
        Me.prov_name.Location = New System.Drawing.Point(182, 136)
        Me.prov_name.Name = "prov_name"
        Me.prov_name.ReadOnly = True
        Me.prov_name.Size = New System.Drawing.Size(232, 20)
        Me.prov_name.TabIndex = 14
        Me.prov_name.Text = ""
        '
        'Label5
        '
        ...
        Me.Label5.Text = "Listado De Cheques"
        ...
        Me.Label6.Location = New System.Drawing.Point(33, 208)
        ...
        Me.LibXLookup1.DestParameters = New String() {"txtprov_code=prov_code", "prov_name=prov_name"}
        Me.LibXLookup1.FilterField = Nothing
        Me.LibXLookup1.IgnoreFindInBrowseMode = False
        Me.LibXLookup1.isCanceled = False
        Me.LibXLookup1.Location = New System.Drawing.Point(410, 136)
        ...
        Me.LibXLookup1.SrcParameters = New String() {"txtprov_code=prov_code"}
        ...
        Me.LibXCombo1.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.DataSet1, "cppaymm.type_prov"))
        ...
        Me.LibxDateTimePicker1.DataBindings.Add(New System.Windows.Forms.Binding("Value", Me.DataSet1, "cppaymm.Fecha_fin"))
        ...
        'TextBox1
        '
        Me.TextBox1.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "cppaymm.paym_number"))
        ...
        Me.LibXCombo2.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.DataSet1, "cppaymm.chequera"))
        ...
        Me.LibXCombo2.Location = New System.Drawing.Point(96, 184)
        Me.LibXCombo2.LookupKeyDisplayFields = "descripcion"
        Me.LibXCombo2.LookupKeyField = "chequera"
        Me.LibXCombo2.LookupTableName = "cpchequera"
        ...
        Me.LibXLookup2.DestParameters = New String() {"suc_code=suc_code", "TextBox2=suc_name"}
        Me.LibXLookup2.FilterField = Nothing
        Me.LibXLookup2.IgnoreFindInBrowseMode = False
        Me.LibXLookup2.isCanceled = False
        Me.LibXLookup2.Location = New System.Drawing.Point(410, 112)
        ...
        'TextBox2
        '
        Me.TextBox2.Location = New System.Drawing.Point(183, 113)
        ...
        'TextBox3
        '
        Me.TextBox3.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "cppaymm.suc_code"))
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            If Not IsNull(e.row!paym_number) Then
                sChqNo = e.row!paym_number.ToString
            End If
            If Not IsNull(e.row!suc_code) Then
                sUcode = e.row!suc_code.ToString
            End If


            If ChB_Detalle.Checked = True Then
                AxCrystalReport1 = New ReportLib("CXP", "r_cppaym08.rpt")
            Else
                AxCrystalReport1 = New ReportLib("CXP", "r_cppaym8.rpt")
            End If
            With AxCrystalReport1
                sWhere = " 1=1 "
                If Trim(sFechaDesde) <> "" And Trim(sFechaHasta) <> "" Then
                    sWhere = String.Concat(sWhere, " and cppaymm.paym_date between '", Trim(sFechaDesde), "' and '", Trim(sFechaHasta), "'")
                ElseIf Trim(sFechaDesde) <> "" Then
                    sWhere = String.Concat(sWhere, " and cppaymm.paym_date = '", Trim(sFechaDesde), "'")
                ElseIf Trim(sFechaHasta) <> "" Then
                    sWhere = String.Concat(sWhere, " and cppaymm.paym_date = '", Trim(sFechaHasta), "'")
                End If
                ...
                End If
                If Trim(sChequera) <> "" Then
                    sWhere = String.Concat(sWhere, "and cppaymm.chequera=", Trim(sChequera))
                End If

                If Trim(sChqNo) <> "" Then
                    sWhere = String.Concat(sWhere, " and cpprovm.paym_number = '", Trim(sChqNo), "'")
                End If
                If Trim(sUcode) <> "" Then
                    sWhere = String.Concat(sWhere, " and cppaymm.suc_code = '", Trim(sUcode), "'")
                End If
