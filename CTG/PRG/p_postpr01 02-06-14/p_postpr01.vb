...
#End Region
    ...
    Dim oReversar As ReversarED.ReversarED
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIniciar.Click
        ...
        Dim oParamr As ReversarED.ParametrosReversarED
        Try
            ...
            oReversar = New ReversarED.ReversarED
            oParamr = New ReversarED.ParametrosReversarED
