...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LibxDateTimePicker1.Location = New System.Drawing.Point(448, 16)
        ...
        Me.btnUnmarkall.Location = New System.Drawing.Point(88, 425)
        ...
        Me.btnMarkAll.Location = New System.Drawing.Point(8, 425)
        ...
        Me.Button10.Location = New System.Drawing.Point(432, 425)
        Me.Button10.Name = "Button10"
        Me.Button10.Size = New System.Drawing.Size(80, 32)
        Me.Button10.TabIndex = 7
        Me.Button10.Text = "Serializar"
        '
        'GroupBox2
        '
        Me.GroupBox2.Controls.Add(Me.chk_Pedidos)
        ...
        Me.GroupBox2.Controls.Add(Me.lblPedidos)
        Me.GroupBox2.Location = New System.Drawing.Point(576, 32)
        Me.GroupBox2.Name = "GroupBox2"
        Me.GroupBox2.Size = New System.Drawing.Size(96, 112)
        ...
        'chk_Pedidos
        '
        Me.chk_Pedidos.Location = New System.Drawing.Point(8, 80)
        Me.chk_Pedidos.Name = "chk_Pedidos"
        Me.chk_Pedidos.Size = New System.Drawing.Size(80, 16)
        Me.chk_Pedidos.TabIndex = 9
        Me.chk_Pedidos.Text = "Pedidos"
        '
        'chk_Devoluciones
        '
        ...
        'lblPedidos
        '
        Me.lblPedidos.BackColor = System.Drawing.Color.Pink
        Me.lblPedidos.Location = New System.Drawing.Point(8, 96)
        Me.lblPedidos.Name = "lblPedidos"
        Me.lblPedidos.Size = New System.Drawing.Size(56, 8)
        Me.lblPedidos.TabIndex = 6
        '
        'LibXNavigator1
        '
        ...
        Me.LibXGrid1.Location = New System.Drawing.Point(8, 152)
        ...
        Me.btnRefresh.Location = New System.Drawing.Point(592, 425)
        ...
        Me.Button1.Location = New System.Drawing.Point(512, 425)
        ...
        Me.Text = "Desplacho de mercancías"
...
#End Region
    ...
    Private Sub XEditTextBoxColumn1_SetCellFormat(ByVal sender As Object, ByVal e As LibX.XDataGridFormatCellEventArgs) Handles XEditTextBoxColumn1.SetCellFormat, _
        ...
        Try
            ...
            AndAlso LibXGrid1.Item(e.RowNumber, 6) = "FCT" Then
                ...
                If Not LibX.IsNull(LibXGrid1.Item(e.RowNumber, 3)) _
                AndAlso LibXGrid1.Item(e.RowNumber, 3) = CustCode Then
                    e.BackColor = lblPedidos.BackColor
                Else
    ...
    Private Sub Aplicar()
        ...
        Try
            ...
            For Each oRow As DataRow In DataSet1.Tables("ftfactd").Select("Aplicar = 1")
                If oRow!type_code.ToString.Trim <> "PDI" _
                And oRow!cust_code.ToString.Trim <> _
                System.Configuration.ConfigurationSettings.AppSettings.Get("LibxCustCode").ToString.Trim Then
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        Try
            ...
            With Param
                .Value = ftfactd.Rows(LibXGrid1.CurrentRowIndex)!ftserial_no
                .Datos.Add("Modo", ftfactd.Rows(LibXGrid1.CurrentRowIndex)!type_code.ToString.Trim)
                .WhereToExecute = "ftfactm.ftserial_no = " & ftfactd.Rows(LibXGrid1.CurrentRowIndex)!ftserial_no.ToString.Trim
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        e.AditionalWhere = "fact_status = 1 and ftfactm.whse_code = " & WhDefault.ToString
    ...
    Private Sub p_ftfact01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            oDocumento = New SGT.Inventario.Entidades.Documento("FCT")

            WhDefault = Val(Configuration.ConfigurationSettings.AppSettings.Get("LibXWhDefault").ToString)
            CustCode = Val(Configuration.ConfigurationSettings.AppSettings.Get("LibXCustCode").ToString)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            xParam.AllowEdit = oDocumento.ExistePedido(LibXGrid1.GetValue(LibXGrid1.CurrentRowIndex, 1))
    ...
    Private Sub ApplyFilter()
        ...
        Try
            ...
            If chk_Pedidos.Checked = True Then
                If Filter.Length = 0 Then
                    Filter = "cust_code = " & CustCode.ToString
                Else
                    Filter = Filter & " and cust_code = " & CustCode.ToString
                End If
            End If
    ...
    Private Sub chk_Pedidos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_Pedidos.CheckedChanged
        Try
            ApplyFilter()
        Catch ex As Exception
            LibX.Log.Show(ex)
