...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents F607 As System.Windows.Forms.CheckBox
    Friend WithEvents DataColumn48 As System.Data.DataColumn
    Friend WithEvents F608 As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.F607 = New System.Windows.Forms.CheckBox
        ...
        Me.F608 = New System.Windows.Forms.CheckBox
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(480, 72)
        ...
        Me.Label5.Size = New System.Drawing.Size(586, 48)
        ...
        'F607
        '
        Me.F607.Location = New System.Drawing.Point(272, 56)
        Me.F607.Name = "F607"
        Me.F607.Size = New System.Drawing.Size(120, 24)
        Me.F607.TabIndex = 39
        Me.F607.Text = "Lennar 607"
        '
        'Txt_Tipo_venta
        '
        ...
        Me.Label8.Location = New System.Drawing.Point(40, 229)
        ...
        Me.Label9.Location = New System.Drawing.Point(56, 136)
        ...
        Me.Label10.Location = New System.Drawing.Point(53, 256)
        ...
        'F608
        '
        Me.F608.Location = New System.Drawing.Point(272, 80)
        Me.F608.Name = "F608"
        Me.F608.Size = New System.Drawing.Size(120, 24)
        Me.F608.TabIndex = 65
        Me.F608.Text = "Lennar 608"
        '
        'r_ptvfact04
        '
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            If F607.Checked = True And Me.F608.Checked = False Then
                ...
                sWhere = String.Concat(sWhere, " and vw_ftdevnccc.fact_status = 2")

                SelecStmt = "SELECT  isnull(len(vw_ftdevnccc.rnc_id),0) as rnctype,vw_ftdevnccc.rnc_id,vw_ftdevnccc.fact_ncf,vw_ftdevnccc.aft_ncf," & _
                ...
                Archivo = System.Configuration.ConfigurationSettings.AppSettings.Get("Libxt607").ToString.Trim
                ...
                ''x607Wrhite.Unprotect("")
                ''x607Add.Unprotect("AAAABABBAAA2")
                ...
                For Each oRow As DataRow In oTable.Rows
                    If Not LibX.IsNull(oRow!fact_ncf) Then
                        ...
                        If oRow!rnctype <> 0 Then
                            x607Wrhite.Range("B" & linea).Value = oRow!rnc_id.ToString.Trim
                        End If
            ...
            Else
                If Me.F608.Checked = True And Me.F607.Checked = False Then
                    ...
                    r607 = New Excel.Application
                    Archivo = System.Configuration.ConfigurationSettings.AppSettings.Get("Libxt608").ToString.Trim
                    Dim x607Open As Excel.Workbooks = r607.Workbooks
                    Dim x607Add As Excel.Workbook = x607Open.Open(Archivo)
                    Dim x607Read As Excel.Sheets = x607Add.Worksheets
                    Dim x607Wrhite As Excel.Worksheet = x607Read(1)
                    ...
                    If Me.F608.Checked = False And Me.F607.Checked = False Then
                        ...
                        With AxCrystalReport1
                            ...
                            If e.row!vend_code.ToString.Trim <> "" Then
                                sWhere = String.Concat(sWhere, " and vw_ftdevnccc.vend_code = ", e.row!vend_code.ToString)
                            End If

                            If e.row!type_code.ToString.Trim <> "" Then
                                sWhere = String.Concat(sWhere, " and vw_ftdevnccc.type_code = '", e.row!type_code.ToString & "'")
                            End If

                            If e.row!moneda.ToString.Trim <> "" Then
                                sWhere = String.Concat(sWhere, " and vw_ftdevnccc.moneda = '", e.row!moneda.ToString & "'")
                            End If

                            If e.row!fact_ncf.ToString.Trim <> "" Then
                                sWhere = String.Concat(sWhere, " and substring(vw_ftdevnccc.fact_ncf,10,2) = '", e.row!fact_ncf.ToString & "'")
                            End If
                            If e.row!fact_cond.ToString.Trim <> "" Then
                                sWhere = String.Concat(sWhere, " and vw_ftdevnccc.fact_cond = ", e.row!fact_cond.ToString)
                            End If
                            If Not IsNull(e.row!cust_code) Then
                                sWhere = String.Concat(sWhere, " and vw_ftdevnccc.cust_code = ", e.row!cust_code.ToString)
                            End If
                            If e.row!fact_status.ToString.Trim <> "" Then
                                If e.row!fact_status.ToString.Trim = 2 Then
                                    sWhere = String.Concat(sWhere, " and vw_ftdevnccc.fact_status <> 0 ")
                                Else
                                    sWhere = String.Concat(sWhere, " and vw_ftdevnccc.fact_status = ", e.row!fact_status.ToString)
                                End If
                            End If
