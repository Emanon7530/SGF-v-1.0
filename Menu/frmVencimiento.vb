...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LibXGrid1.CaptionText = "LISTADO DE PRODUCTOS PROXIMOS A VENCER EN 3 MESES"
        Me.LibXGrid1.DataMember = "ivitemv1"
        Me.LibXGrid1.DataSource = Me.DataSet1
        Me.LibXGrid1.FullRowSelect = False
        Me.LibXGrid1.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.LibXGrid1.IsReadOnly = False
        Me.LibXGrid1.Location = New System.Drawing.Point(0, 8)
        ...
        Me.DataColumn3.ColumnName = "Ano"
        Me.DataColumn3.MaxLength = 4
        '
        'DataColumn4
        '
        ...
        Me.XdataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.XEditTextBoxColumn1, Me.XEditTextBoxColumn2, Me.XEditTextBoxColumn3, Me.XEditTextBoxColumn10, Me.XEditTextBoxColumn4, Me.XEditTextBoxColumn5, Me.XEditTextBoxColumn6, Me.XEditTextBoxColumn7})
        ...
        Me.XEditTextBoxColumn10.HeaderText = "Unidad"
        Me.XEditTextBoxColumn10.ImageList = Nothing
        Me.XEditTextBoxColumn10.isReadOnly = False
        Me.XEditTextBoxColumn10.MappingName = "Unit_code"
        ...
        Me.XEditTextBoxColumn6.HeaderText = "Proveedor"
        Me.XEditTextBoxColumn6.ImageList = Nothing
        Me.XEditTextBoxColumn6.isReadOnly = False
        Me.XEditTextBoxColumn6.MappingName = "prov_code"
        ...
        Me.XEditTextBoxColumn7.HeaderText = "Nombre"
        Me.XEditTextBoxColumn7.ImageList = Nothing
        Me.XEditTextBoxColumn7.isReadOnly = False
        Me.XEditTextBoxColumn7.MappingName = "prov_name"
        ...
        Me.XEditTextBoxColumn7.Width = 200
        '
        'LibXConnector1
        '
        ...
        Me.LibXDbSourceTable1.Source = New String() {"select ivitemv1.item_code,", "ivitemv1.item_name,", "Ano,", "Mes,", "ivvcmted.Existencia,", "ivvcmted.Unit_code,", "ivvcmted.prov_code,", "prov_name ", "FROM ivvcmted", "INNER JOIN ivitemv1", "ON ivitemv1.item_code = ivvcmted.item_code", "INNER JOIN cpprovm", "ON cpprovm.prov_code = ivvcmted.prov_code"}
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        e.AditionalWhere = "Mes <= " & DateTime.Now.AddMonths(3).Month.ToString & " And Ano <= " & DateTime.Now.AddMonths(3).Year.ToString
    ...
    Private Sub frmVencimiento_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        'Try
