...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents CkB_Detallado As System.Windows.Forms.CheckBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.CkB_Detallado = New System.Windows.Forms.CheckBox
        ...
        Me.Fecha_fin.DataBindings.Add(New System.Windows.Forms.Binding("Value", Me.DataSet1, "ccinvcem.Fecha_ini"))
        ...
        Me.txtcust_code.Location = New System.Drawing.Point(96, 112)
        ...
        'cust_name
        '
        Me.cust_name.Location = New System.Drawing.Point(168, 112)
        ...
        Me.Label1.Location = New System.Drawing.Point(50, 136)
        ...
        Me.LibXCombo1.Location = New System.Drawing.Point(96, 136)
        ...
        Me.LibXCombo2.Location = New System.Drawing.Point(296, 184)
        ...
        Me.TextBox1.Location = New System.Drawing.Point(96, 184)
        ...
        Me.LibXLookup2.Location = New System.Drawing.Point(400, 160)
        ...
        'vend_name
        '
        Me.vend_name.Location = New System.Drawing.Point(168, 160)
        ...
        Me.Label7.Location = New System.Drawing.Point(32, 162)
        ...
        'CkB_Detallado
        '
        Me.CkB_Detallado.Location = New System.Drawing.Point(248, 71)
        Me.CkB_Detallado.Name = "CkB_Detallado"
        Me.CkB_Detallado.TabIndex = 35
        Me.CkB_Detallado.Text = "Detallado"
        '
        'LibxDateTimePicker1
        '
        ...
        Me.LibxDateTimePicker1.TabIndex = 36
        '
        'Label8
        '
        ...
        Me.Controls.Add(Me.CkB_Detallado)
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            End If
            If CkB_Detallado.Checked = True Then
                AxCrystalReport1 = New ReportLib("CXC", "r_ccestcta02.rpt")
            Else
            ...
            With AxCrystalReport1
                ...
                'and (ccpaymd.balance <> ccopend.balance or ccpaymd.balance is null)
    ...
    'Private Function CreateFiledisck(ByVal query As String)
    '    Dim FileDisck As String = "C:\tmp\Cxcemp.txt"
    ...
    '        If oRow!cust_code > 0 Then
    '            PrintLine(1, oRow!type_code.ToString.Trim("     ") & Chr(34), line.ToString("000000") & Chr(34), Month(oRow!invce_date).ToString("00") & (oRow!invce_date.day) & Year(oRow!invce_date).ToString("0000") & _
    '            Chr(34), oRow!cust_code & Chr(34), oRow!cust_name & Chr(34), oRow!invce_no & Chr(34), oRow!balance & Chr(34))
    '        End If
    '        line = line + 1
    '    Next
    '    FileClose(1)
