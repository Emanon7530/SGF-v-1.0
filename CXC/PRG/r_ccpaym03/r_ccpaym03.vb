...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents LblSuc_code As System.Windows.Forms.Label
    Friend WithEvents TxtSuc_code As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LblSuc_code = New System.Windows.Forms.Label
        Me.TxtSuc_code = New System.Windows.Forms.TextBox
        ...
        'DataColumn27
        '
        Me.DataColumn27.ColumnName = "invce_create"
        ...
        'cust_name
        '
        Me.cust_name.Location = New System.Drawing.Point(184, 131)
        ...
        Me.LibXLookup1.Location = New System.Drawing.Point(400, 131)
        ...
        Me.Label4.Location = New System.Drawing.Point(65, 132)
        ...
        Me.txtcust_code.Location = New System.Drawing.Point(112, 131)
        ...
        'csttype_name
        '
        Me.csttype_name.Location = New System.Drawing.Point(183, 154)
        ...
        Me.LibXLookup2.Location = New System.Drawing.Point(399, 154)
        ...
        Me.txtcsttype_code.Location = New System.Drawing.Point(111, 154)
        ...
        'type_name
        '
        Me.type_name.Location = New System.Drawing.Point(184, 177)
        ...
        Me.LibXLookup3.Location = New System.Drawing.Point(400, 177)
        ...
        Me.LibXLookup3.SqlString = New String() {"select * from ivtypem", "where type_code in ('FPV','FSG','FCT','FTS')"}
        ...
        Me.txttype_code.Location = New System.Drawing.Point(112, 177)
        ...
        Me.Label7.Location = New System.Drawing.Point(56, 207)
        ...
        Me.LibXCombo1.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ccinvcem.invce_status"))
        ...
        Me.LibXCombo1.Items.AddRange(New Object() {"1-Pendiente", "3-Saldada"})
        Me.LibXCombo1.Location = New System.Drawing.Point(112, 207)
        ...
        Me.LibXCombo1.TabIndex = 29
        '
        'LblSuc_code
        '
        Me.LblSuc_code.AutoSize = True
        Me.LblSuc_code.FlatStyle = System.Windows.Forms.FlatStyle.System
        Me.LblSuc_code.ImageAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.LblSuc_code.Location = New System.Drawing.Point(55, 107)
        Me.LblSuc_code.Name = "LblSuc_code"
        Me.LblSuc_code.Size = New System.Drawing.Size(51, 16)
        Me.LblSuc_code.TabIndex = 30
        Me.LblSuc_code.Text = "Sucursal:"
        Me.LblSuc_code.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        '
        'TxtSuc_code
        '
        Me.TxtSuc_code.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ccinvcem.suc_code"))
        Me.TxtSuc_code.Location = New System.Drawing.Point(112, 104)
        Me.TxtSuc_code.Name = "TxtSuc_code"
        Me.TxtSuc_code.Size = New System.Drawing.Size(64, 20)
        Me.TxtSuc_code.TabIndex = 31
        Me.TxtSuc_code.Text = ""
        '
        'TxtSuc_name
        '
        Me.TxtSuc_name.Location = New System.Drawing.Point(184, 104)
        Me.TxtSuc_name.Name = "TxtSuc_name"
        Me.TxtSuc_name.ReadOnly = True
        Me.TxtSuc_name.Size = New System.Drawing.Size(216, 20)
        Me.TxtSuc_name.TabIndex = 32
        Me.TxtSuc_name.Text = ""
        '
        'LibXLookup4
        '
        ...
        Me.LibXLookup4.DestParameters = New String() {"TxtSuc_code=suc_code", "TxtSuc_name=suc_name"}
        Me.LibXLookup4.FilterField = Nothing
        Me.LibXLookup4.IgnoreFindInBrowseMode = False
        Me.LibXLookup4.isCanceled = False
        Me.LibXLookup4.Location = New System.Drawing.Point(400, 104)
        ...
        Me.LibXLookup4.SrcParameters = New String() {"TxtSuc_code=suc_code"}
        Me.LibXLookup4.TabIndex = 33
        Me.LibXLookup4.TableName = "cgsucursal"
        ...
        Me.LibXLookup4.VisParameters = New String() {"Código=suc_code", "Nombre=suc_name"}
        ...
        Me.ClientSize = New System.Drawing.Size(530, 264)
        Me.Controls.Add(Me.LibXLookup4)
        Me.Controls.Add(Me.TxtSuc_name)
        Me.Controls.Add(Me.TxtSuc_code)
        Me.Controls.Add(Me.LblSuc_code)
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            If Not IsNull(e.row!suc_code) Then
                sSuccode = e.row!suc_code.ToString
            End If
            ...
            If Not IsNull(e.row!invce_status) Then
                sStatus = e.row!invce_status.ToString
            End If

            AxCrystalReport1 = New LibX.ReportLib("CXC", "r_ccpaym03.rpt")

            With AxCrystalReport1
                sWhere = " 1=1 "

                If Trim(sFechaDesde) <> "" And Trim(sFechaHasta) <> "" Then
                    sWhere = String.Concat(sWhere, " and vcc_diariofactura.invce_date between '", Trim(sFechaDesde), "' and '", Trim(sFechaHasta), "'")
                ElseIf Trim(sFechaDesde) <> "" Then
                    sWhere = String.Concat(sWhere, " vcc_diariofactura.invce_date = '", Trim(sFechaDesde), "'")
                ElseIf Trim(sFechaHasta) <> "" Then
                    sWhere = String.Concat(sWhere, " vcc_diariofactura.invce_date = '", Trim(sFechaHasta), "'")
                End If
                ...
                If Trim(sSuccode) <> "" Then
                    sWhere = String.Concat(sWhere, " and vcc_diariofactura.suc_code = ", Trim(sSuccode))
                End If

                If Trim(sCliente) <> "" Then
                    sWhere = String.Concat(sWhere, " and vcc_diariofactura.cust_code = ", Trim(sCliente))
                End If

                If Trim(sTipoC) <> "" Then
                    If sTipoC = "1" Then
                        sWhere = String.Concat(sWhere, " and vcc_diariofactura.csttype_code in(1,11)")
                    Else
                        sWhere = String.Concat(sWhere, " and vcc_diariofactura.csttype_code = ", Trim(sTipoC))
                    End If
                End If

                If Trim(sTipoD) <> "" Then
                    sWhere = String.Concat(sWhere, " and vcc_diariofactura.type_code = '", Trim(sTipoD), "'")
                End If

                If Trim(sStatus) <> "" Then
                    sWhere = String.Concat(sWhere, "and vcc_diariofactura.invce_status = ", Trim(sStatus))
                End If
