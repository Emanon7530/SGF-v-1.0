...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label5.Text = "DOCUMENTOS VENCIDOS DE CLIENTES"
        ...
        Me.LibXCombo2.Items.AddRange(New Object() {"FPV-FACUTAS PUNTO DE VENTA", "FCT-FACTUAS CUENTAS X COBRAR"})
        ...
        Me.Text = "Documentos Vencidos Clientes"
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            AxCrystalReport1 = New ReportLib("CXC", "r_ccpaym06.rpt")
            ...
            With AxCrystalReport1
                ...
                If Trim(sFechaHasta) <> "" Then
                    sWhere = String.Concat(sWhere, "and ccinvcem.due_date<='", Trim(sFechaHasta), "'")
                End If
