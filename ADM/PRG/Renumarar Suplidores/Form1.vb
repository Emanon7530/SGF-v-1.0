...
#End Region
    ...
    Private Sub Actualizar()
        ...
        SelectStmt = "select prov_code from cpprovm order by prov_code"
        ...
        For Each oRow As DataRow In oTable.Rows
            ...
            Dim newCode As String
                ...
                Label1.Text = "Codigo Anterior " & oRow!prov_code.ToString.Trim & ", Codigo ACtual = " & LastNumber
                Label1.Refresh()

                LibX.Data.Manager.ExecuteNonQuery("update ivitemm set prov_code = '" & LastNumber & "' where prov_code = '" & oRow!prov_code.ToString & "'")
                ...
                LibX.Data.Manager.ExecuteNonQuery("update cpprovm set prov_code = '" & LastNumber & "' where prov_code = '" & oRow!prov_code.ToString & "'")
