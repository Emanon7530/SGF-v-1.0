...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LibXConnector1.ModuleName = "ADM"
        ...
        Me.xtxt_UserID.FindState = LibX.IEditProperty.InitialStateEnum.Disabled
...
#End Region
    ...
    Private Sub LibXConnector1_ExecutedAction(ByVal sender As Object, ByVal e As LibX.ExecutingActionEventArgs) Handles LibXConnector1.ExecutedAction
        Try
            If e.Action = LibX.LibxConnectionActions.Find Then
                Me.xtxt_UserID.Text = LibX.User.UserID
            End If
    ...
    Private Sub i_users_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.xtxt_UserID.Text = LibX.User.UserID
    End Sub
