Public Class CajaAbierta
    ...
    Public Sub New(ByVal CajaCode As Integer, ByVal SuCode As Integer)
        Dim oRow As DataRow
        Dim SelectStmt As String

        SelectStmt = "Select * from cjinitm where init_status = 1 and caja_code = " & CajaCode.ToString & " and suc_code = " & SuCode.ToString
    ...
    Public Function GetAbiertaByCajeraID(ByVal CajeraID As Integer, ByVal SuCode As Integer) As Boolean
        Dim oRow As DataRow
        Dim SelectStmt As String

        SelectStmt = "Select * from cjinitm where init_status = 1 and vend_code = " & CajeraID.ToString & " and suc_code = " & SuCode.ToString
        ...
        Return True
    End Function
    Public Function HayCajasAbiertas(ByVal Cajera As Integer, ByVal SuCode As Integer) As Boolean
        Dim Existen As Integer
        Dim SelectStmt As String

        SelectStmt = "Select count(*) from cjinitm where init_status = 1 " & _
                    " and vend_code = " & Cajera.ToString.Trim & " and suc_code =" & SuCode.ToString
