...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        'DataColumn87
        '
        Me.DataColumn87.ColumnName = "Column1"
        Me.DataColumn87.DataType = GetType(System.Decimal)
        Me.DataColumn87.ReadOnly = True
        '
        'pvtarjeta
        '
...
#End Region
    ...
    Dim OImpresionFiscal As SGT.Caja.Operaciones.clsCobroFiscal
    ...
    Private Sub CalcularVuelto()
        Try
            ...
            If Trim(txtTotalPagado.Text) <> String.Empty Then
    ...
    Private Sub CheckTotal()
        ...
        Try
            ...
            If Trim(Me.txtMonCxC.Text) <> String.Empty Then
                ...
                If mCaja.DescuentoCxc = False Then
                    If cxc > CType(Me.txtNeto.Text, Decimal).ToString("###,###,###.##") Then
                        Me.txtMonCxC.Text = String.Empty
                        cxc = 0
                        Me.txtMonEfe.Focus()
                    ...
                    If Val(Me.txtDesc.Text) > 0 And Val(cxc) > 0 And LibXConnector1.CurrentDataRow!type_code = "FPV" Then
                        ...
                        If oAutorizar.isAutorization(oParamValidar) = False Then
                            Me.txtMonTarjeta.Text = String.Empty
            ...
            If Trim(Me.txtMonTarjeta.Text) <> String.Empty Then
            ...
            AndAlso oDocumento.GenerarNCF = True Then
                ...
                If blnSuccess = True Then
                    If Not oParametroNCF.Retorno.NCF Is Nothing Then
                        ...
                        If oParametroNCF.Retorno.Cliente > 0 Then XUpdate.FieldsSet("cust_code") = oParametroNCF.Retorno.Cliente
            ...
            And e.Action <> LibxConnectionActions.Cancel Then
                ...
                If OpenPrinter() Then
                    ...
                    If PrinFisic.IsSucess AndAlso PrinFisic.ReturnCode = 0 Then
                        ...
                        Dim Fact As Factura
                        Dim Egresos As SGT.Caja.Operaciones.EgresoParametros

                        If (Not LibX.IsNull(LibXConnector1.CurrentDataRow!fact_inddomicilio) _
                            AndAlso LibXConnector1.CurrentDataRow!fact_inddomicilio <> 1) _
                            AndAlso (LibXConnector1.CurrentDataRow!type_code = "FPV" Or _
                                     LibXConnector1.CurrentDataRow!type_code = "FSG" Or _
                                     LibXConnector1.CurrentDataRow!type_code = "DEV") Then

                            Fact = SGT.Caja.Operaciones.clsCobroFiscal.FillData(LibXConnector1.CurrentDataRow!ftserial_no)
                        ...
                        Else
                            ''//No fiscalm
                            Egresos = New SGT.Caja.Operaciones.EgresoParametros(LibXConnector1.CurrentDataRow!ftserial_no)

                            If SendToPrinterEpsonNoFiscal(Egresos) Then
                                SetPrinted(LibXConnector1.CurrentDataRow!ftserial_no)
                            End If
                        End If

                    Else
                        Throw New ApplicationException(String.Format("Impresora no esta lista. Error Code: {0}", PrinFisic.ReturnCode))
                    End If
                Else
                    Throw New ApplicationException("El Puerto de la impresora no esta disponible para usar")
                End If
    ...
    Private Function CreateFactory() As IPrintFiscal
        ...
        Dim print As IPrintFiscal = New ImpresionFiscalEpson(factory, Epson, 1, mAquinaCaja.ToString.Trim)
    ...
    Private Function OpenPrinter() As Boolean
        ...
        Try
            ...
            Connected = print.Connect(mAquinaCaja.ToString.Trim())
        Catch ex As Exception
    ...
    Private Function SendToPrinterEpson(ByVal FacturaToPrint As Factura) As Boolean
        ...
        Try
            ...
            Continuo = print.Connect(mAquinaCaja.ToString.Trim())

            If Not Continuo Then
                print.Disconnect()
                Throw New Exception("Ocurrio un error abriendo el puerto de la impresora")
            End If
            ...
            If Not fisicaPrinter.IsSucess Then
                ...
                MessageBox.Show(String.Format("Ocurrio un error imprimiendo. Codigo: {0} - Descripcion: {2} - Status: {1}", _
                                ...
                                "caption", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
    ...
    Private Function SendToPrinterEpsonNoFiscal(ByVal FacturaToPrint As SGT.Caja.Operaciones.EgresoParametros) As Boolean
        ...
        Try
            ...
            Dim a_records() As String = SGT.Caja.Operaciones.Egresos.GetEgresos(FacturaToPrint)
            fisicaPrinter = print.DocumentoNoFiscal(a_records)
    ...
    Private Sub EnabledTAR(ByVal Enabled As Boolean)
        ...
        If Me.txtMonTarjeta.Text.Trim <> String.Empty AndAlso Me.xcbo_tart_code.Text.Trim <> String.Empty Then
            Exit Sub
        End If
    ...
    Private Sub EnabledNC(ByVal Enabled As Boolean)
        Dim e As LibX.XChangeStateEventArgs
        Try
            If Me.txtMonNota.Text.Trim <> String.Empty AndAlso Me.txtinvce_no.Text.Trim <> String.Empty Then
                Exit Sub
            End If
            ...
            Else
                ...
                Me.txtinvce_no.Text = String.Empty
                Me.txtinvce_Serial.Text = String.Empty
                Me.txtinvce_name.Text = String.Empty
    ...
    Private Sub EnabledCHK(ByVal Enabled As Boolean)
        ...
        If Me.txtMonChe.Text.Trim <> String.Empty AndAlso Me.txtNumChe.Text.Trim <> String.Empty Then
            Exit Sub
        End If
        ...
        Try
            ...
            Else
                ...
                Me.txtNumChe.Text = String.Empty
                Me.xtxt_chk_amount.Text = String.Empty
                Me.xtxt_chk_benef.Text = String.Empty
    ...
    Private Sub EnabledCXC(ByVal Enabled As Boolean)
        Dim e As LibX.XChangeStateEventArgs
        If Me.txtMonCxC.Text.Trim <> String.Empty AndAlso Me.txtcust_code.Text.Trim <> String.Empty Then
            Exit Sub
        End If
        ...
        Try
            ...
            Else
                ...
                Me.txtcust_code.Text = String.Empty
            End If
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        Try
            ...
            If ofctDocumento.AplicarCreditoFiscal(oParametroNCF) = True Then
                ...
                XUpdate.FieldsSet("cust_code") = oParametroNCF.Retorno.Cliente
    ...
    Private Sub BuscarNC()
        ...
        Dim oRow As DataRow
        Try
            If Me.txtinvce_no.Text.Trim = String.Empty Then
                Exit Sub
            End If
            ...
            If oRow Is Nothing Then
                ...
                Me.xdt_nc_date.Value = DBNull.Value
                Me.txtinvce_name.Text = String.Empty
                Me.balance.Text = String.Empty
                Me.xtxt_nc_amount.Text = String.Empty
                xtxt_ncr_code.Text = String.Empty
            Else
    ...
    Private Sub xcbo_tart_code_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles xcbo_tart_code.SelectedIndexChanged
