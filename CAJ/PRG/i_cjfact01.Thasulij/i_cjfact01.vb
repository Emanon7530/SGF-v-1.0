...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        Me.cjtranrv.Constraints.AddRange(New System.Data.Constraint() {New System.Data.UniqueConstraint("Constraint1", New String() {"ftserial_no"}, True)})
        Me.cjtranrv.PrimaryKey = New System.Data.DataColumn() {Me.DataColumn61}
        ...
        Me.xlk_cust_code.DestParameters = New String() {"cust_code=cust_code", "txtbus_name=cust_name", "txtaddress=cust_address", "xtxt_phone1=cust_phone", "xtxt_phone2=cust_cellphone", "xtxt_balance=balance", "xtxt_credit_limit=credit_limit", "xtxncf_type=ncf_type", "txtCliNombre=cust_name"}
...
#End Region
    ...
    Private Sub AplicarCobro()
        ...
        Try
            ...
            AndAlso oDocumento.GenerarNCF = True Then
                ...
                If LibXConnector1.CurrentDataRow!type_code = "FSG" Then
                ...
                If blnSuccess = True Then
                    If Not oParametroNCF.Retorno.NCF Is Nothing Then
                        ...
                        If Not LibX.IsNull(oParametroNCF.Retorno.Cliente) And LibX.IsNull(oParametroNCF.Retorno.CustCode) Then XUpdate.FieldsSet("cust_code") = oParametroNCF.Retorno.Cliente
    ...
    Private Sub xlk_cust_code_AfterSetValues(ByVal sender As Object, ByVal e As LibX.LookupValuesEventArgs) Handles xlk_cust_code.AfterSetValues
        ...
        Me.txtbus_name.Text = e.row!cust_name & " " & e.row!cust_apellidos
        Dim XUpdate As New LibX.Data.XUpdateStmt("ftfactm")
        XUpdate.FieldsSet("bus_name") = e.row!cust_name.ToString.Trim & " " & e.row!cust_apellidos.ToString.Trim
        XUpdate.Fields("ftserial_no") = LibXConnector1.CurrentDataRow!ftserial_no
        XUpdate.Execute()
    End Sub
