...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'DataTable1
        '
        Me.DataTable1.Columns.AddRange(New System.Data.DataColumn() {Me.DataColumn1, Me.DataColumn2, Me.DataColumn3, Me.DataColumn4, Me.DataColumn5, Me.DataColumn6, Me.DataColumn7, Me.DataColumn19, Me.DataColumn20})
        ...
        Me.xcob_init_status.Items.AddRange(New Object() {"2-Cerrada", "1-Abierta"})
        ...
        Me.btnLimpiar.Location = New System.Drawing.Point(160, 208)
        Me.btnLimpiar.Name = "btnLimpiar"
        Me.btnLimpiar.Size = New System.Drawing.Size(88, 40)
...
#End Region
    ...
    Private Sub LibXConnector1_RowChange(ByVal sender As Object, ByVal e As LibX.XRowChangeEventArgs) Handles LibXConnector1.RowChange
        Try
            If LibXConnector1.HasRecords = True Then
                ...
                btndesglo.Enabled = LibX.IsNull(LibXConnector1.CurrentDataRow!init_status)
                btnLimpiar.Enabled = Not LibX.IsNull(LibXConnector1.CurrentDataRow!no_cierre)
            End If
        Catch ex As Exception
            LibX.Log.Show(ex)
        End Try
    ...
    Private Sub LibXShortNavigator1_AfterClick(ByVal sender As Object, ByVal e As XMsaComponents.XMsaActionClickEventArgs) Handles LibXShortNavigator1.AfterClick
        ...
        '''        Else
        '''            AxCrystalReport1 = New LibX.ReportLib("CAJ", "r_cjinit01Chino.rpt")
        '''        End If
    ...
    Private Sub btnLimpiar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLimpiar.Click
        ...
        Try
            If MessageBox.Show("Seguro que desea Borrar todo?", "Borrar Datos", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                ...
                '//Eliminar los registros de cierre q hayan
                XDelete = New LibX.Data.XDeleteStmt("cjcierrm")
                XDelete.Fields("init_serial") = LibXConnector1.CurrentDataRow!init_serial
                XDelete.Execute()

                XDelete = New LibX.Data.XDeleteStmt("cjtranrm")
                XDelete.Fields("init_serial") = LibXConnector1.CurrentDataRow!init_serial
                XDelete.Execute()

                SelectStmt = "select * from ftfactd where ftserial_no in(select ftserial_no from ftfactm " & _
                       " where init_serial = " & LibXConnector1.CurrentDataRow!init_serial & ")"

                oTAble = LibX.Data.Manager.GetDataTable(SelectStmt)

                For Each orow As DataRow In oTAble.Rows
                    XDelete = New LibX.Data.XDeleteStmt("ftfactd")
                ...
                XDelete = New LibX.Data.XDeleteStmt("cjinitm")
                XDelete.Fields("init_serial") = LibXConnector1.CurrentDataRow!init_serial
                XDelete.Execute()

                xUpdate = New LibX.Data.XUpdateStmt("cjcajam")
                xUpdate.FieldsSet("no_cierre") = 0
                xUpdate.Fields("caja_code") = LibXConnector1.CurrentDataRow!caja_code
                xUpdate.Execute()

                xUpdate = New LibX.Data.XUpdateStmt("ivtypen")
                xUpdate.FieldsSet("last_number") = 0
                xUpdate.Fields("type_code") = "FPV"
                xUpdate.Execute()
