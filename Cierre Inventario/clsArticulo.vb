Public Class Articulo
    ...
    Public Class ParametrosCostosLocales
        ...
        Public TotalITBIS As Decimal = 0

        Public IncluirDescuento As Boolean = False
        Public IncluirITBIS As Boolean = False
    ...
    Public Function AplicarITBIS(ByVal e As ParametrosAplicarItbis) As Boolean
        ...
        For Each oRow As DataRow In oTable.Rows
            With oParamLocal
                ...
                .PagaItbis = e.PagaITBIS
            End With

            CalcularCostoLocal(oParamLocal)
            With XUpdate
                '// Cambio
                .FieldsSet("taxable") = e.PagaITBIS
    ...
    Public Function CalcularCostoLocal(ByVal e As ParametrosCostosLocales) As Boolean
        ...
        Try
            ...
            '// Paga ITBIS
            e.PagaItbis = Me.PagaItbis(e.Producto)
            ...
            MontoITBIS = ((e.TotalITBIS * 100) / e.Itbis)
            ...
            '// CAlcular Itbis
            If e.TotalITBIS > 0 AndAlso e.IncluirITBIS = True AndAlso e.PagaItbis = True Then
                e.ValoresRetorno.Itbis = ((e.Costo * e.Cantidad) - e.ValoresRetorno.descuento) * (e.Itbis / 100)
            End If
            ...
            If e.Precio <= 0 Then
                e.ValoresRetorno.Precio = (e.ValoresRetorno.costo * (e.Beneficio / 100)) + e.ValoresRetorno.costo
                e.ValoresRetorno.Beneficio = e.Beneficio
            Else
                e.ValoresRetorno.costo = e.Costo
                e.ValoresRetorno.Precio = e.Precio
                e.ValoresRetorno.Beneficio = ((e.Precio - e.ValoresRetorno.costo) / e.ValoresRetorno.costo) * 100
            End If

            If e.PagaItbis = True AndAlso e.IncluirITBIS = False Then
                e.ValoresRetorno.Itbis = ((e.Costo * e.Cantidad) - e.ValoresRetorno.descuento) * (e.Itbis / 100)
            End If

            If e.PagaItbis = True Then
    ...
    Public Function PagaItbis(ByVal Producto As String) As Boolean
        Dim Taxable As Integer
        Dim XSelect As LibX.Data.XSelecStmt
        Dim SelectStmt As String
        Try
