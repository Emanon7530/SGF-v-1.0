...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LibXDbSourceTable3.Source = New String() {"select ivetiqm.*, ivitemv1.item_name,ivitemv1.ubicacion,ivitemv1.asumir_emp", "from ivetiqm, ivitemv1, stinform", "where ivetiqm.item_code = ivitemv1.item_code", "order by etiq_no"}
        ...
        Me.Label5.Text = "IMPRESION DE ETIQUETAS"
        ...
        Me.TextBox3.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ivetiqm.prov_code"))
        Me.TextBox3.Location = New System.Drawing.Point(132, 136)
        ...
        Me.Label4.Location = New System.Drawing.Point(68, 136)
        ...
        Me.LibXCombo1.Items.AddRange(New Object() {"0-Generado", "1-Impreso"})
        ...
        Me.LibXLookup1.DestParameters = New String() {"item_code=item_code", "abreviada=abreviada", "almacen=almacen", "lblwhse_name=whse_name", "prov_code=prov_code", "lblprov_name=prov_name", "estado=estado", "cantidad=cantidad"}
        ...
        Me.LibXLookup1.SqlString = New String() {"select m.item_code,m.abreviada,m.almacen,h.whse_name,", "m.prov_code,p.prov_name,m.estado,m.cantidad", "from ivetiqm m", "left  join  ivwhsem h", "on m.almacen=h.whse_code", "left join cpprovm p", "on  m.prov_code=p.prov_code"}
        ...
        Me.LibXLookup1.VisParameters = New String() {"Código=item_code", "Abreviada=abreviada", "Código Almacén=almacen", "Almacén Nombre =whse_name", "Suplidor=prov_code", "Nombre=prov_name", "Estado=estado", "Cantidad=cantidad"}
        ...
        Me.LibXLookup3.DestParameters = New String() {"prov_code=prov_code", "lblprov_name=prov_name"}
        Me.LibXLookup3.FilterField = "prov_name"
        Me.LibXLookup3.IgnoreFindInBrowseMode = False
        Me.LibXLookup3.isCanceled = False
        Me.LibXLookup3.Location = New System.Drawing.Point(476, 136)
        Me.LibXLookup3.LookCaption = "Proveedores"
        ...
        Me.LibXLookup3.VisParameters = New String() {"Codigo=prov_code", "Nombre=prov_name"}
        ...
        Me.lblprov_name.Location = New System.Drawing.Point(204, 136)
        Me.lblprov_name.Name = "lblprov_name"
        Me.lblprov_name.Size = New System.Drawing.Size(272, 20)
        Me.lblprov_name.TabIndex = 37
        '
        'Label10
        '
        ...
        Me.xcbo_printmode.DefaultWhereString = "mod_default = 1"
        ...
        'ChkPrecio
        '
        Me.ChkPrecio.Location = New System.Drawing.Point(132, 232)
        Me.ChkPrecio.Name = "ChkPrecio"
        Me.ChkPrecio.Size = New System.Drawing.Size(91, 24)
        Me.ChkPrecio.TabIndex = 43
        Me.ChkPrecio.Text = "Precio S o N"
        '
        'TextBox1
        '
        Me.TextBox1.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.TextBox1.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ivetiqm.cantidad"))
        Me.TextBox1.Location = New System.Drawing.Point(388, 208)
        ...
        Me.Label11.Location = New System.Drawing.Point(328, 208)
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As System.Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        Try
            ...
            Dim serial, etiq As Integer
            Dim valor_itbis As Decimal
            Dim fecha As String
            Dim mes, anio As String
            Dim SelectStmt As String
            Dim FileEtiq As String = "C:\tmp\Etique.txt"
            Dim xUpdate As LibX.Data.XUpdateStmt

            ''If e.row!estado.ToString.Trim = 0 Then
            ''    e.Where = String.Concat(e.Where, " or  ivetiqm.estado is null ")
            ''End If
            ...
            SelectStmt = "select * from ivetiqmod where mod_default = 1 " ' where mod_serial = " & Me.xcbo_printmode.currValue.ToString
            ...
            ''xUpdate.Fields("etiq_no").value = oTable.Rows!etiq_no
            ''xUpdate.Execute()
            ...
            For Each oRow As DataRow In oTable.Rows
                ...
                If oRowPrinter!mod_name = "LP2844Z" And oRowPrinter!mod_default = 1 Then
                    ...
                    If Not oRowPrinter!sec_empresa Is DBNull.Value Or Not oRowempresa!comp_name Is DBNull.Value Then
                        PrintLine(1, oRowPrinter!sec_empresa.ToString & "," & Chr(34) & oRowempresa!comp_name & Chr(34))
                    End If

                    '// Codigo Barra
                    If Not oRowPrinter!sec_barra Is DBNull.Value Or Not oRow!item_code Is DBNull.Value Then
                        PrintLine(1, oRowPrinter!sec_barra.ToString & "," & Chr(34) & oRow!item_code.ToString & Chr(34))
                    End If
                    ...
                    SelectStmt = "select isnull(taxable,0) from ivitemm where item_code ='" & item & "'"
                    ...
                    If item <> "" And supli <> "" Then
                        SelectStmt = "select isnull(vcmto_month,0) from ivvcmtod " & _
                                     " where doc_serial =" & serial & " and item_code ='" & item & "' and prov_code =" & supli & "" & _
                    ...
                    End If
                    If item <> "" And supli <> "" Then
                        SelectStmt = "select isnull(vcmto_year,0) from ivvcmtod " & _
                                     " where doc_serial =" & serial & " and item_code ='" & item & "' and prov_code =" & supli & "" & _
                                     " and unit_code is not null "
                    ...
                    '// precio
                    If Me.ChkPrecio.Checked = True Then
                    ...
                    If (oRow!unidad_venta <> oRow!unidad_compra) And Not oRow!precio2 Is DBNull.Value Then
                        ...
                        '// Unidad Compra
                        If Not oRowPrinter!sec_unidad2 Is DBNull.Value And Not LibX.IsNull(oRow!unidad_compra.ToString) Then
                    ...
                    If Not oRowPrinter!sec_producto Is DBNull.Value Then
                        PrintLine(1, oRowPrinter!sec_ubica.ToString & "," & Chr(34) & oRow!ubicacion.ToString & Chr(34))
                    End If
                    ...
                    '// Actualizar etiqueta
                ElseIf oRowPrinter!mod_name <> "M9412" And oRowPrinter!mod_default = 1 Then

                    If Not oRowPrinter!sec_file Is DBNull.Value Then
                        Dim ArrayString() As String = Split(oRowPrinter!sec_file, vbCrLf)
                        ...
                        For i As Int16 = 0 To ArrayString.Length - 1
                            ...
                            If Not oRowempresa!comp_name Is DBNull.Value Then
                                ArrayString(i) = ArrayString(i).Replace("{empresa}", oRowempresa!comp_name & vbCrLf)
                            End If

                            '// Codigo Barra
                            If Not oRow!item_code Is DBNull.Value Then
                                ArrayString(i) = ArrayString(i).Replace("{barra}", oRow!item_code.ToString & vbCrLf)
                            End If

                            '// Telefono
                            If Not oRowempresa!comp_phone1 Is DBNull.Value Then
                                ArrayString(i) = ArrayString(i).Replace("{telefono}", oRowempresa!comp_phone1 & vbCrLf)
                            End If
                            item = oRow!item_code.ToString
                            supli = oRow!prov_code.ToString

                            '// Factura de Compra
                            If Not oRow!fact_no Is DBNull.Value Then
                                ArrayString(i) = ArrayString(i).Replace("{factura}", oRow!fact_no.ToString & vbCrLf)
                            End If

                            '// Fecha de Compra
                            fecha = oRow!fecha_factura.ToString.Trim
                            If fecha <> "" Then
                                ArrayString(i) = ArrayString(i).Replace("{fecha compra}", Format(oRow!fecha_factura, "dd/MM/yyyy") & vbCrLf)
                            End If
                            ...
                            '// Suplidor
                            If Not oRow!prov_code Is DBNull.Value Then
                                ArrayString(i) = ArrayString(i).Replace("{suplidor}", oRow!prov_code.ToString & vbCrLf)
                            ...
                            If Me.ChkPrecio.Checked = True Then
                                If itbis > 0 Then
                                    ArrayString(i) = ArrayString(i).Replace("{precio_detalle}", Format(oRow!precio * (valor_itbis / 100 + 1), "###,##0.00") & vbCrLf)
                                Else
                                    ArrayString(i) = ArrayString(i).Replace("{precio_detalle}", Format(oRow!precio, "###,##0.00") & vbCrLf)
                                End If
                            End If

                            '// Unidad Venta
                            ArrayString(i) = ArrayString(i).Replace("{unidad_detalle}", oRow!unidad_venta.ToString & vbCrLf)

                            If (oRow!unidad_venta <> oRow!unidad_compra) And Not oRow!precio2 Is DBNull.Value Then
                                '// precio
                                If Me.ChkPrecio.Checked = True Then
                                    If itbis > 0 Then
                                        ArrayString(i) = ArrayString(i).Replace("{precio_mayor}", Format(oRow!precio2 * (valor_itbis / 100 + 1), "###,##0.00") & vbCrLf)
                                    Else
                                        ArrayString(i) = ArrayString(i).Replace("{precio_mayor}", Format(oRow!precio2, "###,##0.00") & vbCrLf)
                                    End If
                                End If

                                '// Unidad Compra
                                If Not LibX.IsNull(oRow!unidad_compra.ToString) Then
                                    ArrayString(i) = ArrayString(i).Replace("{unidad_mayor}", oRow!unidad_compra.ToString & vbCrLf)
                                End If
                            End If

                            '// Ubicacion del producto
                            ArrayString(i) = ArrayString(i).Replace("{ubicacion}", oRow!ubicacion.ToString & vbCrLf)

                            '// Codigo Producto
                            ArrayString(i) = ArrayString(i).Replace("{producto}", oRow!abreviada.ToString & vbCrLf)

                            '// Imprimir
                            If ArrayString(i).IndexOf("{") <= 0 Then
                                PrintLine(1, ArrayString(i))
                            End If
                    ...
                    End If
                Else
                    PrintLine(1, oRowPrinter!inicio_etiqueta.ToString, "," & oRow!cantidad.ToString.Trim, "|")
                    ...
                    If Not oRowPrinter!sec_suplidor Is DBNull.Value Or Not oRow!prov_code Is DBNull.Value Then
                        If mes <> "" And anio <> "" Then
                            PrintLine(1, oRowPrinter!sec_suplidor.ToString & "," & Chr(34) & Format(oRow!prov_code, "000") & mes & "/" & anio.ToString & Chr(34), "|")
                        Else
                            PrintLine(1, oRowPrinter!sec_suplidor.ToString & "," & Chr(34) & oRow!prov_code.ToString & Chr(34), "|")
                        End If
                    ...
                    If (oRow!unidad_venta <> oRow!unidad_compra) And Not oRow!precio2 Is DBNull.Value Then
                        ...
                        End If
                    End If
                    PrintLine(1, "012" & "," & Chr(34) & oRow!item_code.ToString & Chr(34), "|")
                    '    End If
                ...
                xUpdate.Fields("etiq_no") = oRow!etiq_no
                xUpdate.Execute()
                xUpdate.Dispose()
            Next
    ...
    Private Sub ImprimirEtiqueta(ByVal FileNameToPrint As String, ByVal PrinterName As String)
        ...
        ''Dim cmdUpdate As New LibX.Data.XSelecStmt

        ''With cmdUpdate
        ''    .Command.CommandText = ("Nombre del procedimiento")
        ''    .Command.CommandType = CommandType.StoredProcedure
        ''    .Parameters.Add("pcodigo", txtcodigo.Text))
        ''    .Parameters.Add("pnombre", txtnombres.Text)
        ''    .Parameters.Add("ptelefono", txttelefono.Text)
        ''    .Command.CommandTimeout = 2000000
        ''End With
        ''cmdUpdate.Command.ExecuteNonQuery()
