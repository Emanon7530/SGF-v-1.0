...
Public Class r_iventr606
    Inherits System.Windows.Forms.Form
    Dim r606 As Excel.Application
    Dim x606Open As Excel.Workbooks
    Dim x606Add As Excel.Workbook
    Dim x606Read As Excel.Sheets
    Dim x606Wrhite As Excel.Worksheet
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents chklist_mes As System.Windows.Forms.CheckedListBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.chklist_mes = New System.Windows.Forms.CheckedListBox
        ...
        Me.Label5.Size = New System.Drawing.Size(658, 48)
        ...
        Me.Chk_Normal.Location = New System.Drawing.Point(256, 160)
        ...
        'Chk_606
        '
        Me.Chk_606.Checked = True
        Me.Chk_606.CheckState = System.Windows.Forms.CheckState.Checked
        Me.Chk_606.Location = New System.Drawing.Point(192, 64)
        Me.Chk_606.Name = "Chk_606"
        Me.Chk_606.Size = New System.Drawing.Size(224, 24)
        Me.Chk_606.TabIndex = 42
        Me.Chk_606.Text = "606 - Compras de Bienes y Servicios"
        '
        'chklist_mes
        '
        Me.chklist_mes.Location = New System.Drawing.Point(432, 96)
        Me.chklist_mes.Name = "chklist_mes"
        Me.chklist_mes.Size = New System.Drawing.Size(120, 184)
        Me.chklist_mes.TabIndex = 43
        '
        'cbo_anio
        '
        Me.cbo_anio.Items.AddRange(New Object() {"2019", "2018", "2017", "2016", "2015", "2014"})
        Me.cbo_anio.Location = New System.Drawing.Point(432, 64)
        Me.cbo_anio.Name = "cbo_anio"
        Me.cbo_anio.Size = New System.Drawing.Size(121, 21)
        Me.cbo_anio.TabIndex = 44
        '
        'Button1
        '
        ...
        Me.Controls.Add(Me.chklist_mes)
...
#End Region
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            If Chk_606.Checked = True Then
                For Each mes As String In chklist_mes.Items

                    sWhere = " 1=1 "
                    sWhere = String.Concat(sWhere, " and year(doc_date) = ", cbo_anio.Text)
                    sWhere = String.Concat(sWhere, " and month(doc_date) = ", mes)
                    ...
                    '" CASE WHEN cpinvcem.invce_ncfafect is null THEN 'A010010010100000000' ELSE cpinvcem.invce_ncfafect END as invce_ncfafect," & _
                    SelecStmt = " select cpprovm.rnc_id,cpinvcem.invce_service,cpservices.service_name,invce_ncf," & _
                                " cpinvcem.invce_ncfafect as invce_ncfafect," & _
                                " cpinvcem.doc_date,cpinvcem.doc_date as fecha_pago,cpinvcem.itbis," & _
                                " '0' as itbis_retenido,cpinvcem.amount " & _
                                "from cpinvcem inner join cpprovm on cpprovm.prov_code = cpinvcem.prov_code and cpprovm.rnc_id <> '19' " & _
                                " left join cpservices on cpservices.service_code = cpinvcem.invce_service where invce_ncf is not null"
                    ...
                    x606Open = r606.Workbooks
                    x606Add = x606Open.Open(Archivo)
                    x606Read = x606Add.Worksheets
                    x606Wrhite = x606Read(1)
                    ...
                    For Each oRow As DataRow In oTable.Rows
                        ...
                        End If
                        serv = IIf(IsNull(oRow!invce_service), 0, oRow!invce_service)
    ...
    Private Sub r_ftfact10_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For intAnio As Integer = 1 To 12
            chklist_mes.Items.Add(intAnio.ToString())
        Next

        cbo_anio.Items.Clear()

        For intAnio As Integer = DateTime.Now.Year() To 2014 Step -1
            cbo_anio.Items.Add(intAnio.ToString())
        Next

    End Sub

    Private Sub CheckedListBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chklist_mes.SelectedIndexChanged

    End Sub

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        For i As Integer = 0 To chklist_mes.Items.Count - 1
            chklist_mes.SetItemChecked(i, Not chklist_mes.GetItemChecked(i))
        Next
    End Sub
End Class
