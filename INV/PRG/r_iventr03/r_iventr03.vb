...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label5.Text = "REPORTE DE ESTADISTICA"
        ...
        Me.LibXLookup1.VisParameters = New String() {"Código=group_code", "Descripción=group_name"}
        ...
        Me.XTextBox5.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSet1, "ivtranrm.item_code"))
        ...
        'Chkdetallado
        '
        Me.Chkdetallado.Location = New System.Drawing.Point(240, 72)
        Me.Chkdetallado.Name = "Chkdetallado"
        Me.Chkdetallado.TabIndex = 43
        ...
        Me.Name = "r_iventr03"
        Me.Text = "Reporte de Estadistica"
    ...
    Private Sub LibXConnector1_BeforeExecuteQuery(ByVal sender As Object, ByVal e As LibX.XBeforeExecuteQueryEventArgs) Handles LibXConnector1.BeforeExecuteQuery
        ...
        Try
            ...
            If Chkdetallado.Checked = False Then
                AxCrystalReport1 = New LibX.ReportLib("INV", "r_iventr03.rpt")
            Else
                AxCrystalReport1 = New LibX.ReportLib("INV", "r_iventr3.rpt")
            End If
            ...
            With AxCrystalReport1
                ...
                If sWh <> "" Then
                    sWhere = String.Concat(sWhere, " and ivtranrd.whse_code = ", sWh)
                End If
                ...
                If sIt <> "" Then
                    sWhere = String.Concat(sWhere, " and ivitemm.item_code = ", sIt)
                End If
                Else

                    If sWh <> "" Then
                        sWhere = String.Concat(sWhere, " and estadistv.whse_code = ", sWh)
                    End If

                    If sGr <> "" Then
                        sWhere = String.Concat(sWhere, " and estadistv.group_code = ", sGr)
                    End If

                    If sIt <> "" Then
                        sWhere = String.Concat(sWhere, " and estadistv.item_code = ", sIt)
                    End If
                End If
