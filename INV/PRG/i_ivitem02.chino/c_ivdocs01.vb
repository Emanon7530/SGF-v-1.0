...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(0, 441)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(1020, 8)
        ...
        Me.btnView.Location = New System.Drawing.Point(8, 457)
        ...
        Me.btnCerrar.Location = New System.Drawing.Point(940, 456)
        ...
        'ivtranrm
        '
        Me.ivtranrm.Columns.AddRange(New System.Data.DataColumn() {Me.DataColumn9, Me.DataColumn10, Me.DataColumn11, Me.DataColumn12, Me.DataColumn13, Me.DataColumn14, Me.DataColumn15, Me.DataColumn16, Me.DataColumn17, Me.DataColumn1, Me.DataColumn2, Me.DataColumn3, Me.DataColumn4, Me.DataColumn5, Me.DataColumn6, Me.DataColumn7})
        ...
        Me.LibXDbSourceTable2.Source = New String() {"select origen,ivtranrm.trane_number,ivtranrm.type_code,[type_name],doc_number,doc" & _
        "_serial,doc_date", ",case ivtypem.type_code when 'ADJ'", " then (ivtranrd.qty*factor) else ", "(case doc_input when 1 then (ivtranrd.qty*factor) else (ivtranrd.qty*factor)*-1 e" & _
        "nd) end qty", ",ivtranrd.costo,ivtranrd.price,", "case ivtypem.type_code when 'ADJ'", "then isnull(bf_onhand,0)+((isnull(qty,0)*factor)) ", "else isnull(bf_onhand,0)+((isnull(qty,0)*factor)* (case doc_input when 1 then 1 e" & _
        "lse -1 end)) end rs_onhand,ivtranrd.bf_onhand", "from ivtranrm inner join ivtranrd on ivtranrm.trane_number = ivtranrd.trane_numbe" & _
        "r", "inner join ivtypem on ivtranrm.type_code = ivtypem.type_code", "inner join ivunitd on ivunitd.item_code = ivtranrd.item_code", "and ivunitd.unit_code = ivtranrd.unit_code", "order by ivtranrm.trane_number", ""}
        ...
        Me.LibXGrid1.Size = New System.Drawing.Size(844, 408)
        ...
        Me.XEditTextBoxColumn8.Width = 40
        '
        'XEditTextBoxColumn9
        '
        ...
        Me.XEditTextBoxColumn11.Width = 85
        '
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(860, 8)
        Me.GroupBox2.Name = "GroupBox2"
        Me.GroupBox2.Size = New System.Drawing.Size(160, 432)
        ...
        Me.chk_devfacturas.Size = New System.Drawing.Size(144, 16)
        Me.chk_devfacturas.TabIndex = 16
        Me.chk_devfacturas.Text = "Devoluciones Facturas"
        '
        'lbldevfacturas
        '
        ...
        Me.lbldevfacturas.Size = New System.Drawing.Size(144, 8)
        ...
        Me.chk_ajuste.Size = New System.Drawing.Size(144, 16)
        Me.chk_ajuste.TabIndex = 14
        Me.chk_ajuste.Text = "Ajuste Inventario"
        '
        'lblAjuste
        '
        ...
        Me.lblAjuste.Size = New System.Drawing.Size(144, 8)
        ...
        Me.chk_facturas.Size = New System.Drawing.Size(144, 16)
        ...
        Me.lblFactura.Size = New System.Drawing.Size(144, 8)
        ...
        Me.chk_devoluc.Size = New System.Drawing.Size(144, 16)
        Me.chk_devoluc.TabIndex = 10
        Me.chk_devoluc.Text = "Devoluciones Inventario"
        '
        'lblDevoluciones
        '
        ...
        Me.lblDevoluciones.Size = New System.Drawing.Size(144, 8)
        ...
        Me.chk_entradas.Size = New System.Drawing.Size(144, 16)
        Me.chk_entradas.TabIndex = 10
        Me.chk_entradas.Text = "Entradas de Almacen"
        '
        'lblEntradas
        '
        ...
        Me.lblEntradas.Size = New System.Drawing.Size(144, 8)
        ...
        Me.chk_salida.Size = New System.Drawing.Size(144, 16)
        Me.chk_salida.TabIndex = 10
        Me.chk_salida.Text = "Salida Inventario"
        '
        'lblSalida
        '
        ...
        Me.lblSalida.Size = New System.Drawing.Size(144, 8)
        ...
        Me.ClientSize = New System.Drawing.Size(1028, 486)
...
#End Region
        ...
        Try
            ...
            If chk_devoluc.Checked = True Then
                If Filter.Length = 0 Then
                    Filter = "type_code in ('DVI')"
                Else
                    Filter = Filter & " and type_code in ('DVI')"
                End If
            End If

            If Me.chk_devfacturas.Checked = True Then
                If Filter.Length = 0 Then
                    Filter = "type_code in ('DVF')"
                Else
                    Filter = Filter & " and type_code in ('DVF')"
                End If
            End If
    ...
    Private Sub XEditTextBoxColumn1_SetCellFormat(ByVal sender As System.Object, ByVal e As LibX.XDataGridFormatCellEventArgs) Handles XEditTextBoxColumn8.SetCellFormat, XEditTextBoxColumn9.SetCellFormat, XEditTextBoxColumn10.SetCellFormat, XEditTextBoxColumn11.SetCellFormat, XEditTextBoxColumn12.SetCellFormat, XEditTextBoxColumn13.SetCellFormat, XEditTextBoxColumn14.SetCellFormat, XEditTextBoxColumn16.SetCellFormat, XEditTextBoxColumn1.SetCellFormat
        Try
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        Try
            ...
            If LibXGrid1.GetValue(LibXGrid1.CurrentRowIndex, 0) = "DVI" Then
                ...
                LibX.LibXRunner.Run("i_ivdevm01", "FCT", True)
            End If
